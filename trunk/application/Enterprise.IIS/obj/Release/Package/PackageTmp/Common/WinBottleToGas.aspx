<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinBottleToGas.aspx.cs" Inherits="Enterprise.IIS.Common.WinBottleToGas" %>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20000" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            runat="server" EnableCheckBoxSelect="True" DataKeyNames="FCode,FName,FSpec" OnPageIndexChange="Grid1_PageIndexChange"
                                            ...
                                            OnRowDoubleClick="Grid1_RowClick" EnableMultiSelect="False">
                                            <Columns>
