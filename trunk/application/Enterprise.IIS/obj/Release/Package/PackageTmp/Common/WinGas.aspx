<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinGas.aspx.cs" Inherits="Enterprise.IIS.Common.WinGas" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFCode" runat="server"  AutoPostBack="True" OnTextChanged="tbxFText_OnTextChanged" Label="商品代码">
                                                        </f:TextBox>
                                                        <f:TextBox ID="txtFName" runat="server"  AutoPostBack="True" OnTextChanged="tbxFText_OnTextChanged" Label="商品名称">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
