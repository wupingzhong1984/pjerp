<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinBottle.aspx.cs" Inherits="Enterprise.IIS.Common.WinBottle" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFCode" AutoPostBack="True" OnTextChanged="tbxFText_OnTextChanged"  runat="server" Label="商品代码">
                                                        </f:TextBox>
                                                        <f:TextBox ID="txtFName" AutoPostBack="True" OnTextChanged="tbxFText_OnTextChanged"  runat="server" Label="商品名称">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20000" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            EnableRowDoubleClickEvent="true" EnableRowClickEvent="true"  EnableMultiSelect="True" KeepCurrentSelection="True"
                                            OnRowDoubleClick="Grid1_RowClick">
                                            <Columns>
