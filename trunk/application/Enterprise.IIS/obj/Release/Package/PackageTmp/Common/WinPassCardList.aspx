<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinPassCardList.aspx.cs" Inherits="Enterprise.IIS.Common.WinPassCardList" %>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="2000" ShowBorder="false" ShowHeader="false" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="120px" DataField="KeyId" HeaderText="单据号" SortField="KeyId" TextAlign="Center" runat="server" />
