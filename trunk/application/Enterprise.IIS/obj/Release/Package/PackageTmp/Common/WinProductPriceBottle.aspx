<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WinProductPriceBottle.aspx.cs" Inherits="Enterprise.IIS.Common.WinProductPriceBottle" %>
                                        ...
                                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        <f:TextBox ID="txtFSpell" runat="server" AutoPostBack="True" OnTextChanged="tbxFText_OnTextChanged"   Label="助记码">
                                                        </f:TextBox>


                                                        <f:TextBox ID="txtFCode" runat="server" Label="商品代码" AutoPostBack="True" OnTextChanged="tbxFText_OnTextChanged"  >
                                                        </f:TextBox>
                                                        <f:TextBox ID="txtFName" runat="server" Label="商品名称" AutoPostBack="True" OnTextChanged="tbxFText_OnTextChanged"  >
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20000" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            runat="server" EnableCheckBoxSelect="True" DataKeyNames="FBottleCode" OnPageIndexChange="Grid1_PageIndexChange"
                                            IsDatabasePaging="true" OnSort="Grid1_Sort" SortDirection="ASC"  EnableMultiSelect="True"
                                             EnableRowDoubleClickEvent="true" OnRowDoubleClick="Grid1_RowClick" KeepCurrentSelection="true"
                                            AllowSorting="true" EmptyText="查询无结果" EnableHeaderMenu="True">
                                            <Columns>
                                                
                                                <f:BoundField MinWidth="80px" DataField="FBottleCode" HeaderText="包装物代码" SortField="FCode" />
                                                <f:BoundField MinWidth="220px" DataField="FBottleName" HeaderText="包装物名称" SortField="FName" />
