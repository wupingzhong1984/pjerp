<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.PurchaseReturn.Edit" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFReconciliation" runat="server" Label="对账单号" EmptyText="对账单号" />
                                                    </Items>
                                                </f:FormRow>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFFreight" runat="server" Label="运输服务费" Text="0.00" Readonly="True">
                                                        </f:TextBox>
                                                ...
                                                <f:FormRow ID="FormRow4">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlDeliveryMethod" Label="提货方式" Required="True" ShowRedStar="True" EnableEdit="True" />
                                                        ...
                                                        <f:TextBox ID="txtFAmt" runat="server" Label="退款金额" EmptyText="退款金额" Text="0.00">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
