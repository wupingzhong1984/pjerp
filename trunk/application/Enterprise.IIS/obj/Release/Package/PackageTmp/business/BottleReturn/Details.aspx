<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.BottleReturn.Details" %>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        ...
                                                        <f:Label ID="lblFFreight" runat="server" Label="运输服务费" Hidden="True">
                                                        </f:Label>
                                                    </Items>
                                                </f:FormRow>
