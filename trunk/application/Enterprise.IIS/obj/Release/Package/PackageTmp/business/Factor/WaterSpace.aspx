<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WaterSpace.aspx.cs" Inherits="Enterprise.IIS.business.Factor.WaterSpace" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" ShowBorder="False" ShowHeader="False" Title="引入罐车水溶积" Position="Center"
                                    ...
                                    <Items>
                                        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="135px" EnableAjax="true"
                                            ...
                                            <Items>
                                                <f:GroupPanel runat="server" Title="模版下载" ID="GPanelRoleInfo" EnableCollapse="True">
                                                    <Items>
                                                        ...
                                                        <f:ContentPanel ID="ContentPanel1" ShowBorder="false" BodyPadding="10px" ShowHeader="false"
                                                            ...
                                                            <a href="~/business/template/水溶积.xls" runat="server">下载模版</a>
                                                        </f:ContentPanel>
                                                    </Items>
                                                </f:GroupPanel>
                                                ...
                                                <f:Grid ID="Grid1" Title="引入罐车水溶积" ShowBorder="false" ShowHeader="False"
                                                    ...
                                                    <Columns>
                                                        <f:BoundField Width="100px" DataField="罐号" HeaderText="罐号" SortField="罐号" />
                                                        <f:BoundField Width="100px" DataField="底盘号" HeaderText="底盘号" SortField="底盘号" />
                                                        <f:BoundField Width="100px" DataField="水容积（M3）" HeaderText="水容积（M3）" SortField="水容积（M3）" />
                                                    </Columns>
                                                </f:Grid>
                                            </Items>
                                        </f:SimpleForm>
