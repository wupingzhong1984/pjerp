<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InitCustomerAR.aspx.cs" Inherits="Enterprise.IIS.business.Init.InitCustomerAR" %>
                                            ...
                                            <Items>
                                                <f:GroupPanel runat="server" Title="模版下载" ID="GPanelRoleInfo" EnableCollapse="True">
                                                    <Items>
                                                        ...
                                                        <f:ContentPanel ID="ContentPanel1" ShowBorder="false" BodyPadding="10px" ShowHeader="false"
                                                            ...
                                                            <a href="~/business/template/初始客户应收账款.xls" runat="server">下载模版</a>
                                                        </f:ContentPanel>
                                                    </Items>
                                                </f:GroupPanel>
                                                ...
                                                <f:Grid ID="Grid1" Title="初始客户应收账款" ShowBorder="false" ShowHeader="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <f:BoundField Width="100px" DataField="应收账款" HeaderText="应收账款" SortField="应收账款" />
                                                    </Columns>
                                                </f:Grid>
                                            </Items>
                                        </f:SimpleForm>
