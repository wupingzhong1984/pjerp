<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.BottleDetection.Edit" %>
                ...
                <f:Region ID="Region1" Title="钢瓶检测" Position="Center"
                    ...
                    <Items>
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="True" Title="编辑钢瓶检测" Split="False"
