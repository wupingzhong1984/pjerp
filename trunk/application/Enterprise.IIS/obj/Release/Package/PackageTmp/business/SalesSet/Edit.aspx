<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.SalesSet.Edit" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20"
                                            ...
                                            <Toolbars>
                                                <f:Toolbar ID="Toolbar1" runat="server">
                                                    <Items>
                                                        ...
                                                        <f:Button ID="btnPassCardToSales" runat="server" Text="订单To销售"
                                            ...
                                            <Columns>
                                                ...
                                                <f:RenderField MinWidth="100px" Hidden="True" ColumnID="FRecycleQty" DataField="FRecycleQty" FieldType="Int" TextAlign="Right"
                                                    HeaderText="空瓶回收">
                                                    <Editor>
