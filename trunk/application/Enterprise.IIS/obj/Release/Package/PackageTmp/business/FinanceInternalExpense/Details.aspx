<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.FinanceInternalExpense.Details" %>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="False" EnableAfterEditEvent="true" OnAfterEdit="Grid1_AfterEdit"
                                            ...
                                            AllowSorting="False" EmptyText="查询无结果" EnableHeaderMenu="True" AllowCellEditing="False" ClicksToEdit="1">
                                            <Toolbars>
                                                ...
                                                <f:GroupField HeaderText="银行账户" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        <f:RenderField MinWidth="180px" ColumnID="FCode" DataField="FCode" FieldType="String"
                                                            HeaderText="编码">
                                                            <Editor>
                                                                <f:TriggerBox ID="tbxBankCode" Readonly="false" TriggerIcon="Search" runat="server" EnablePostBack="False">
                                                                </f:TriggerBox>
                                                            </Editor>
                                                        </f:RenderField>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid2" ShowBorder="False" ShowHeader="False" AllowPaging="False" EnableAfterEditEvent="true" OnAfterEdit="Grid1_AfterEdit"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FFreight" HeaderText="运输服务费" SortField="FFreight" />
