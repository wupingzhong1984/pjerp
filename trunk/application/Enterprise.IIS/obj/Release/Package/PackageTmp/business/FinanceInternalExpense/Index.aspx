<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.FinanceInternalExpense.Index" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="False" runat="server">
            <Regions>
                ...
                <f:Region ID="Region1" Title="现金费用单" Position="Center"
                    ShowBorder="False" BoxConfigAlign="Stretch" Layout="Fit" runat="server" ShowHeader="False">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items> 
                                <f:Label runat="server" ID="headerText" Text="现金费用单"/>
                                <f:ToolbarSeparator ID="ToolbarSeparator2" runat="server" />
                                <f:Button ID="btnSearch" OnClick="btnSearch_Click" runat="server" Text="查询" Icon="Zoom" Hidden="False" Size="Medium">
                                </f:Button>
                                <f:Button ID="btnAdd" runat="server" OnClientClick="openAddUI();" Text="新增" Icon="CoinsDelete" Hidden="True" Size="Medium">
                                </f:Button>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFItemName" runat="server" Label="科目名称">
                                                        </f:TextBox>
                                                        <f:TextBox ID="txtFKeyId" runat="server" Label="单据编号">
                                                        </f:TextBox>
                                                        <f:TextBox ID="txtFName" runat="server" Label="客户名称" Hidden="true">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FCode" HeaderText="科目编码" SortField="FCode" />
                                                <f:BoundField MinWidth="220px" DataField="FName" HeaderText="科目名称" SortField="FName" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/FinanceInternalExpense/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '【现金费用单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/FinanceInternalExpense/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '添加现金费用单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/FinanceInternalExpense/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '【编辑现金费用单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
