<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.SalesReturn.Index" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <f:Region ID="Region1" Title="销售退货" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="销售退货单"/>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFItemName" runat="server" Label="客户代码">
                                                        </f:TextBox>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FT6Status" HeaderText="上传" SortField="FT6Status" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" DataField="FDistributionPoint" HeaderText="作业区" SortField="FDistributionPoint" />
                                                <f:BoundField MinWidth="80px" DataField="FDate" HeaderText="退货日期" SortField="FDate" DataFormatString="{0:yyyy-MM-dd}" TextAlign="Center"/>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FAmount" HeaderText="货款" SortField="FAmount" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FSubjectName" HeaderText="银行账户" SortField="FSubjectName" TextAlign="Left" />
                                                <f:BoundField MinWidth="120px" DataField="FAmt" HeaderText="退款" SortField="FAmt" TextAlign="Right" />
        ...
        function openDetailsUI(keyid) {
            var url = 'business/SalesReturn/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【销售退货单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/SalesReturn/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加销售退货单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/SalesReturn/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑销售退货单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
