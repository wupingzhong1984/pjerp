<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankCheak.aspx.cs" Inherits="Enterprise.IIS.business.Reports.BankCheak" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>财务账户核销汇总表</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="财务账户核销汇总表" Position="Center"
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="False" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <%--<f:LinkButtonField MinWidth="160px" ColumnID="ACode"  CommandName="actView" DataTextField="ACode" 
                                                    HeaderText="账户编码" SortField="ACode" TextAlign="Left" runat="server" />--%>
                                                <f:BoundField MinWidth="130px"  ColumnID="ACode" DataField="ACode" HeaderText="账户编码" SortField="ACode" />
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="AName" HeaderText="银行账户" SortField="AName" />
                                                <f:BoundField MinWidth="120px" ColumnID="FAmt"  DataField="FAmt" HeaderText="账户金额" SortField="FAmt" TextAlign="Right" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
