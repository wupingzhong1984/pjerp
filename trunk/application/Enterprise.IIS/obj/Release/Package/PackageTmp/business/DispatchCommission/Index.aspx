<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.DispatchCommission.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="送货提成单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="送货提成单"/>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFItemName" runat="server" Label="商品名称" LabelAlign="Right">
                                                        </f:TextBox>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FSpQty" HeaderText="实瓶数量" SortField="FSpQty" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FSpSumPrice" HeaderText="实瓶工资" SortField="FSpSumPrice" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FKpQty" HeaderText="空瓶数量" SortField="FKpQty" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FKpSumPrice" HeaderText="空瓶工资" SortField="FKpSumPrice" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FSum" HeaderText="总计工资" SortField="FSum" TextAlign="Right" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/DispatchCommission/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【送货提成单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/DispatchCommission/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加送货提成单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/DispatchCommission/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑送货提成单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
