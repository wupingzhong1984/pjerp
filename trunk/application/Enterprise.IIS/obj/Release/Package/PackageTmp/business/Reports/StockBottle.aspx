<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="StockBottle.aspx.cs" Inherits="Enterprise.IIS.business.Reports.StockBottle" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                ...
                <f:Region ID="Region1" Title="气瓶库存" Position="Center"
                                        ...
                                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlDistributionPoint" Label="作业区" LabelAlign="Right"></f:DropDownList>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20000" ShowBorder="false" ShowHeader="false" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="80px" ColumnID="FCode" DataField="FCode" HeaderText="气瓶编码" SortField="FCode" />
                                                <f:BoundField MinWidth="220px" ColumnID="FName" DataField="FName" HeaderText="气瓶名称" SortField="FName" />
                                                ...
                                                <f:BoundField MinWidth="120px" ColumnID="FDistributionPoint" DataField="FDistributionPoint" HeaderText="作业区" SortField="FDistributionPoint" TextAlign="Center" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
