<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesIndex.aspx.cs" Inherits="Enterprise.IIS.business.TubeInvo.SalesIndex" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="发货单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="氢气销售"/>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/TubeInvo/SalesEdit.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【氢气销售' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/TubeInvo/SalesEdit.aspx?action=1';
        ...
        function openEditUI(keyid) {
            var url = 'business/TubeInvo/SalesEdit.aspx?KeyId=' + keyid + '&action=2';
