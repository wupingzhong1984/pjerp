<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SupplierMonthProc.aspx.cs" Inherits="Enterprise.IIS.business.Reports.SupplierMonthProc" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>供应商每月应收款统计</title>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                ...
                <f:Region ID="Region1" Title="供应商每月应收款统计" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px"  ColumnID="FInitAP" DataField="FInitAP" HeaderText="期初应付款" SortField="FInitAP" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px"  ColumnID="FPeriodAP"  DataField="FPeriodAP" HeaderText="本期应付款" SortField="FPeriodAP" TextAlign="Center" />
                                                ...
                                                <f:BoundField MinWidth="120px"  ColumnID="FPeriodPay"  DataField="FPeriodPay" HeaderText="本期付款" SortField="FPeriodPay" TextAlign="Center" />
                                                ...
                                                <f:BoundField MinWidth="120px"  ColumnID="FFinalAP"  DataField="FFinalAP" HeaderText="期未应付款" SortField="FFinalAP" TextAlign="Center" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
        ...
        <f:Window ID="Window1" runat="server" WindowPosition="Center" IsModal="True" EnableClose="True"
            Icon="ApplicationViewDetail" Title="供应商档案" EnableMaximize="True" EnableResize="True" Hidden="True"
