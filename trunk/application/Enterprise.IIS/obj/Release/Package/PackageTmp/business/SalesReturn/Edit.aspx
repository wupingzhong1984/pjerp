<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.SalesReturn.Edit" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="销售退货单" Position="Center"
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:TriggerBox ID="tbxFCustomer" EnablePostBack="True" OnTextChanged="tbxFCustomer_OnTextChanged" LabelAlign="Right"
                                                ...
                                                <f:FormRow ID="FormRow4">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlDeliveryMethod" Label="配送方式" Required="True" ShowRedStar="True" EnableEdit="True"  LabelAlign="Right"/>
                                                        <f:TextBox ID="txtFLogisticsNumber" runat="server" Label="物流单号" LabelAlign="Right">
                                                        </f:TextBox>
                                                        <f:DropDownList runat="server" ID="ddlSubject" Label="银行账户"  LabelAlign="Right">
                                                        </f:DropDownList>
                                                        <f:TextBox ID="txtFAmt" runat="server" Label="退款金额" EmptyText="退款金额" Text="0.00" LabelAlign="Right">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                            ...
                                            <Toolbars>
                                                <f:Toolbar ID="Toolbar1" runat="server">
                                                    <Items>
                                                        ...
                                                        <f:Button ID="btnClose" EnablePostBack="False" Text="关闭" runat="server" Icon="SystemClose" onClientClick="closeActiveTab();" Size="Medium">
                                                        </f:Button>
                                                    </Items>
                                                </f:Toolbar>
                                            </Toolbars>
