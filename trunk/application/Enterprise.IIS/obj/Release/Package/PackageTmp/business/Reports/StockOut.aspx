<%@ Page Language="C#" AutoEventWireup="true"
     CodeBehind="StockOut.aspx.cs" Inherits="Enterprise.IIS.business.Reports.StockOut" %>
                        ...
                        <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" LabelWidth="80px" EnableCollapse="False"
                            ...
                            <Items>
                                ...
                                <f:DropDownList runat="server" ID="ddlBill" Label="业务类型">
                                    ...
                                    <f:ListItem Text="销售出仓" Value="1" />
                                    <f:ListItem Text="采购退货出仓" Value="5" />
                                    <f:ListItem Text="调拨出仓" Value="3" />
                                    <f:ListItem Text="气瓶租赁出仓" Value="7" />
                                    <f:ListItem Text="盘亏出仓" Value="9" />
                                    <f:ListItem Text="空瓶出仓" Value="16" />
                                    <f:ListItem Text="其它出仓" Value="20" />
                                </f:DropDownList>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="Button1" OnClick="btnExports_Click" runat="server" Text="引出出库详细" Icon="PageExcel"
                                    Hidden="False" EnableAjax="false" DisableControlBeforePostBack="false" Size="Medium">
                                </f:Button>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FTypeName" HeaderText="出仓类型" SortField="FTypeName" />
