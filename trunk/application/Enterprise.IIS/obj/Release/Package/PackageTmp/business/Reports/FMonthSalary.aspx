<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMonthSalary.aspx.cs" Inherits="Enterprise.IIS.business.Reports.FMonthSalary" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="160px" ColumnID="FSalesman" TextAlign="Center" DataField="FSalesman" HeaderText="业务员" SortField="FSalesman" />
