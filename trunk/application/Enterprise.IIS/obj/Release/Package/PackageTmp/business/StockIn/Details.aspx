<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.StockIn.Details" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:Label runat="server" ID="ddlFCate" Label="入仓类型"/>
                                                    </Items>
                                                </f:FormRow>
