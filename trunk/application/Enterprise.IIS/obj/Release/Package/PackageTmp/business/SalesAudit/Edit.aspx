<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.SalesAudit.Edit" %>
                                        ...
                                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:DatePicker ID="txtFDate" runat="server" Required="false" Label="配送日期" EmptyText="日期" LabelAlign="Right"
                                                            ShowRedStar="false" Enabled="False">
                                                        </f:DatePicker>
                                                ...
                                                <f:FormRow ID="FormRow5">
                                                    <Items>
                                                        <f:DatePicker ID="txtFT6Date" runat="server" Required="false" Label="财务日期" EmptyText="日期" LabelAlign="Right"
                                                            ShowRedStar="false">
                                                        </f:DatePicker>
                                                ...
                                                <f:FormRow ID="FormRow6">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlT6Status" Label="T6标识" 
                                                            Required="True" LabelAlign="Right" ShowRedStar="True" 
                                                            EnableEdit="True" >
                                                            <f:ListItem Text="未同步" Value="未同步" Selected="true" />
                                                            <f:ListItem Text="已同步" Value="已同步"  />
                                                        </f:DropDownList>
                                                    </Items>
                                                </f:FormRow>
