<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProductionCost.aspx.cs" Inherits="Enterprise.IIS.business.Reports.ProductionCost" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="装卸计价" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FItemCode" HeaderText="产品代码" SortField="FItemCode" />
                                                <f:BoundField MinWidth="110px" DataField="FItemName" HeaderText="商品名称" SortField="FItemName" />
                                                <f:BoundField MinWidth="60px" DataField="FSpec" HeaderText="规格" SortField="FSpec" />
                                                <f:BoundField MinWidth="60px" DataField="FUnit" HeaderText="单位" SortField="FUnit" />

                                                <f:BoundField MinWidth="80px" ColumnID="FQty" DataField="FQty" HeaderText="生产数量" SortField="FQty" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" ColumnID="FMISName" DataField="FMISName" HeaderText="原料名称" SortField="FMISName" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" ColumnID="FMISQty" DataField="FMISQty" HeaderText="原料量(KG)" SortField="FMISQty" TextAlign="Right" />
