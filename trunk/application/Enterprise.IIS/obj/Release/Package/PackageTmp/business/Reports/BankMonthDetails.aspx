<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BankMonthDetails.aspx.cs" Inherits="Enterprise.IIS.business.Reports.BankMonthDetails" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DatePicker ID="dpkFDateEnd" LabelAlign="Right" runat="server" Label="结束时间" DateFormatString="yyyy-MM-dd">
                                                        </f:DatePicker>
                                                    </Items>
                                                </f:FormRow>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="130px"  ColumnID="FName" DataField="FName" HeaderText="单号" SortField="FName" />
                                                <f:BoundField MinWidth="130px"  ColumnID="CreateBy" DataField="CreateBy" HeaderText="操做员" SortField="CreateBy" />
