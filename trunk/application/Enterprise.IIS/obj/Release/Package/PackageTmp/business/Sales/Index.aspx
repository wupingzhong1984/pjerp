<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.Sales.Index" %>
...
<body>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnTubeSales" OnClick="btnTubeSales_Click" runat="server" Text="转排管车"
                                    Icon="CartGo" Hidden="True" Size="Medium">
                                </f:Button>
                                <f:Button ID="btnAudit" OnClick="btnAudit_Click" runat="server" Text="审核"
                                    Icon="PageAttach" Hidden="True" Size="Medium">
                                </f:Button>
    ...
    <script type="text/javascript">
        ...
        function openAddUI() {
            var url = 'business/Sales/Edit.aspx?action=1';
        ...
        function openEditUI(keyid) {
            var url = 'business/Sales/Edit.aspx?KeyId=' + keyid + '&action=2';
