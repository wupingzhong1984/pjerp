<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.VehicleRepare.Edit" %>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFSupercargo" Label="申购人" EnableEdit="True" EnableMultiSelect="true"  LabelAlign="Right"/>
                                                        <f:DropDownList runat="server" ID="ddlFShipper" Label="采购人" EnableEdit="True"  LabelAlign="Right"/>
                                                ...
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFMemo" MaxLength="200" MaxLengthMessage="最大长度限定200个字符以内" runat="server" Label="备注" EmptyText="备注" LabelAlign="Right">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
