<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidSalesIndex.aspx.cs" Inherits="Enterprise.IIS.business.Liquid.LiquidSalesIndex" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/Liquid/LiquidSalesDetails.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【发货单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Liquid/LiquidSalesEdit.aspx?action=1';
        ...
        function openEditUI(keyid) {
            var url = 'business/Liquid/LiquidSalesEdit.aspx?KeyId=' + keyid + '&action=2';
