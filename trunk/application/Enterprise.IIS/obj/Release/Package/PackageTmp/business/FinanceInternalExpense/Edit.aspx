<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.FinanceInternalExpense.Edit" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:TextBox runat="server" Label="报账人工号" ID="txtFCode"  Required="True" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        <f:TriggerBox ID="tbxFCustomer" EnablePostBack="True" OnTextChanged="tbxFCustomer_OnTextChanged"
                                                            ShowLabel="true" ShowRedStar="True" Required="true" Label="报账人"
                                ...
                                <f:Region ID="Region5" ShowBorder="False" ShowHeader="false" Position="Bottom"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid2" ShowBorder="False" ShowHeader="False" AllowPaging="False" EnableAfterEditEvent="true" OnAfterEdit="Grid2_AfterEdit"
                                            runat="server" EnableCheckBoxSelect="False" DataKeyNames="KeyId,FId" EnableSummary="true" SummaryPosition="Bottom" OnRowCommand="Grid2_RowCommand"
