<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SaleNotChecked.aspx.cs" Inherits="Enterprise.IIS.business.Reports.SaleNotChecked" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>未核销发货单据明细表</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="未核销发货单据明细表" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="130px"  ColumnID="FType" DataField="FType" HeaderText="业务" SortField="FType" />
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="KeyId" HeaderText="发货单号" SortField="KeyId" />
                                                <f:BoundField MinWidth="120px" ColumnID="FAmount"  DataField="FAmount" HeaderText="销售金额" SortField="FAmount" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="CheckedFAmt" HeaderText="已核销" SortField="CheckedFAmt" />
                                                <f:BoundField MinWidth="120px" ColumnID="FNoCheckedAmt" DataField="FNoCheckedAmt" HeaderText="未核销" SortField="FNoCheckedAmt" />
                                                <f:BoundField MinWidth="120px" DataField="FSKNum" HeaderText="关联收款单号" SortField="FSKNum" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
