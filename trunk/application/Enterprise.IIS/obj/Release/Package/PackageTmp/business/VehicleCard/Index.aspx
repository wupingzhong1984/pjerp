<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.VehicleCard.Index" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region2" Title="证照审核" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="130px" DataField="FCertificateDate" HeaderText="营运证年审时间" SortField="FCertificateDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="130px" DataField="FDrivingDate" HeaderText="行驶证年审时间" SortField="FDrivingDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="130px" DataField="FDeadlineDate" HeaderText="交强险截止时间" SortField="FDeadlineDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="130px" DataField="FCommercialDate" HeaderText="商业险截止时间" SortField="FCommercialDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="130px" DataField="FDangerousDate" HeaderText="危险品承运险截止时间" SortField="FDangerousDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="130px" DataField="FTankDate" HeaderText="罐体检测时间" SortField="FTankDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="130px" DataField="FTwostageDate" HeaderText="二级维护时间" SortField="FTwostageDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="130px" DataField="FRegistrationDate" HeaderText="登记评定时间" SortField="FRegistrationDate" DataFormatString="{0:yyyy-MM-dd}" />
