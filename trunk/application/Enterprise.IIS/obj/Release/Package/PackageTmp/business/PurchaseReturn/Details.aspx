<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.PurchaseReturn.Details" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="采购退货单" Position="Center"
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="210px" EnableCollapse="True">
                                    <Items>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:Label ID="txtFReconciliation" runat="server" Label="对账单号"/>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        <f:Label runat="server" Label="客户代码" ID="txtFCode"/>
                                                        <f:Label ID="txtFName" Label="客户名称" runat="server">
                                                        </f:Label>
                                                        <f:Label ID="txtFAddress" runat="server" Label="地址">
                                                        </f:Label>
                                                        <f:Label ID="txtFPhone" runat="server" Label="电话">
                                                        </f:Label>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:Label ID="txtFLinkman" runat="server" Label="联系人">
                                                        </f:Label>
                                                        <f:Label ID="txtFFreight" runat="server" Label="运输服务费">
                                                        </f:Label>
                                                        <f:Label runat="server" ID="txtFSupercargo" Label="押运员"/>
                                                        <f:Label runat="server" ID="txtFShipper" Label="发货人"/>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        <f:Label runat="server" ID="txtFVehicleNum" Label="车牌号" />
                                                        <f:Label runat="server" ID="txtFDriver" Label="送货司机"/>
                                                        <f:Label runat="server" ID="txtFArea" Label="区域"/>
                                                        <f:Label runat="server" ID="txtFSalesman" Label="业务员"/>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow4">
                                                    <Items>
                                                        <f:Label runat="server" ID="txtFDeliveryMethod" Label="取货方式" />
                                                        <f:Label ID="txtFLogisticsNumber" runat="server" Label="物流单号">
                                                        </f:Label>
                                                        <f:Label ID="txtFAmount" runat="server" Label="应付金额">
                                                        </f:Label>
                                                        <f:Label ID="txtFAmt" runat="server" Label="实付金额">
                                                        </f:Label>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow5">
                                                    <Items>
                                                        <f:Label runat="server" ID="txtARAmt" Label="目前欠款" />
    ...
    <script type="text/javascript">
        ...
        function LodopPrinter(keyid) {
            ...
            var strHtml = "";
            $.post("../../common/AjaxPrinter.ashx?oper=ajaxPrintPurchaseReturn",
				  { "keyid": keyid },
              function (result) {
                  if (result != "") {
