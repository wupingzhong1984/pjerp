<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.FinanceSK.Edit" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        #RegionPanel1_Region1_RegionPanel2_Region3_SimpleForm1_FormRow1_ddlFAbstract-labelEl {
            color: red;
        }
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="120px" EnableCollapse="True">
                                    <Items>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFAbstract" ShowLabel="True" ShowRedStar="True" LabelAlign="Right" Label="收款类型" Required="True">
                                                            <f:ListItem Text="" Value="-1"  />
                                                            <f:ListItem Text="正常收款" Value="正常收款" Selected="true"/>
                                                            <f:ListItem Text="收租金款" Value="收租金款" />
                                                            <f:ListItem Text="收押金款" Value="收押金款" />
                                                            <f:ListItem Text="退押金款" Value="退押金款" />
                                                        </f:DropDownList>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        ...
                                                        <f:Label runat="server" Label="本期优惠" ID="lblDisAmount" Text="0.00" />
                                ...
                                <%--<f:Region ID="Region5" ShowBorder="False" ShowHeader="false" Position="Bottom"
                                    MinHeight="220px" Layout="Fit" runat="server" BodyPadding="3px" AutoScroll="True">
                                    <Items>
                                        <f:Grid ID="Grid2" ShowBorder="False" ShowHeader="False" AllowPaging="False" EnableAfterEditEvent="true" OnAfterEdit="Grid1_AfterEdit"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" ID="FAmount" DataField="FAmount" HeaderText="应收款" SortField="FAmount" />
