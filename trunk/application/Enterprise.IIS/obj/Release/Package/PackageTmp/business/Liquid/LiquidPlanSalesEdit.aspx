<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidPlanSalesEdit.aspx.cs" Inherits="Enterprise.IIS.business.Liquid.LiquidPlanSalesEdit" %>
                ...
                <f:Region ID="Region1" Title="液体销售订单" Position="Center"
                    ...
                    <Items>
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="True" Title="编辑液体销售订单" Split="False"
