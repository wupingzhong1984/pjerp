<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="GasIndex.aspx.cs" Inherits="Enterprise.IIS.business.Item.GasIndex" %>
...
<body>
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        <f:Button ID="btnAddClass" OnClick="btnAddClass_Click" runat="server" Text="新增" Icon="FeedAdd" Hidden="False" Size="Medium">
                        </f:Button>
                        <f:Button ID="btnEditClass" OnClick="btnEditClass_Click" runat="server" Hidden="False" Text="编辑"
                            Icon="FeedEdit" Size="Medium">
                        </f:Button>
                        <f:Button ID="btnDeleteClass" ConfirmText="你确认要删除操作吗?" OnClick="btnDeleteClass_Click" runat="server" Text="删除"
                            Icon="FeedDelete" Hidden="False" Size="Medium">
                        </f:Button>
                        ...
                        <f:Button ID="btnAdd" Enabled="False" runat="server" Text="新增" Icon="Add" Hidden="True" Size="Medium">
                        </f:Button>
            ...
            <Regions>
                <f:Region ID="Region1" ShowHeader="false" Split="true"
                    ShowBorder="False" Width="200px" Position="Left" Layout="Fit" runat="server">
                    <Items>
                        <f:Tree ID="trDept" Width="50px" OnNodeCommand="trDept_NodeCommand" ShowHeader="False"
                            ShowBorder="false" Icon="House" Title="气体分类" runat="server" EnableTextSelection="true"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="100px" DataField="FBottleName" HeaderText="包装物" SortField="FBottleName" />
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FINum" HeaderText="用友存货码" SortField="FINum" />
    ...
    <script type="text/javascript">
        ...
        function openAddFineUI(url) {
            parent.addExampleTab.apply(null, ['add_fineui_gas', basePath + url, '引入气体档案', basePath + 'icon/database_add.png', true]);
        }
