<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.Produce.Edit" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DatePicker ID="txtFDate" runat="server" Required="false" Label="领料日期" EmptyText="领料日期"
                                                            ShowRedStar="false">
                                                        </f:DatePicker>
                                                        <f:DropDownList runat="server" ID="ddlFCate" Label="出仓类型" EnableEdit="True" Required="True" ShowRedStar="True" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlOrgnization" Label="领用部门" />
                                                        <f:TextBox ID="txtFLinkman" MaxLength="20" runat="server" Label="领用人" EmptyText="领用人" Required="True" ShowRedStar="true">
                                                        </f:TextBox>
                                                ...
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlFReceiver" Label="发货人" EnableEdit="True" LabelAlign="Right" />
