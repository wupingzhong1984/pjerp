<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesPlanDetails.aspx.cs" Inherits="Enterprise.IIS.business.Reports.SalesPlanDetails" %>
                    ...
                    <Items>
                        <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" LabelWidth="80px" EnableCollapse="False"
                            ...
                            <Items>
                                ...
                                <f:TextBox runat="server" ID="txtKeyId" Label="订单编码" />
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" ColumnID="FDeliveryMethod" DataField="FDeliveryMethod" HeaderText="配送方式" SortField="FDeliveryMethod" />
                                                ...
                                                <f:BoundField MinWidth="100px" ColumnID="FINum"  DataField="FINum" HeaderText="商品代码" SortField="FINum" />
                                                <f:BoundField MinWidth="120px" Hidden="true" ColumnID="FItemCode"  DataField="FItemCode" HeaderText="商品代码" SortField="FItemCode" />
