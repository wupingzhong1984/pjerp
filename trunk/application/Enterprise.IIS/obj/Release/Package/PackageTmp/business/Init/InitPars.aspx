<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InitPars.aspx.cs" Inherits="Enterprise.IIS.business.Init.InitPars" %>
                                                ...
                                                <f:GroupPanel runat="server" Title="模版下载" ID="GPanelRoleInfo" EnableCollapse="True">
                                                    <Items>
                                                        ...
                                                        <f:ContentPanel ID="ContentPanel1" ShowBorder="false" BodyPadding="10px" ShowHeader="false"
                                                            ...
                                                            <a href="~/business/template/附件档案.xls" runat="server">下载模版</a>
                                                        </f:ContentPanel>
                                                    </Items>
                                                </f:GroupPanel>
