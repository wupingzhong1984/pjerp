<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidPlanPurchase.aspx.cs" Inherits="Enterprise.IIS.business.Liquid.LiquidPlanPurchase" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="液体采购订单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="液体采购订单"/>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/Liquid/LiquidPlanPurchaseDetails.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【液体采购订单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Liquid/LiquidPlanPurchaseEdit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加液体采购订单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Liquid/LiquidPlanPurchaseEdit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑液体采购订单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
