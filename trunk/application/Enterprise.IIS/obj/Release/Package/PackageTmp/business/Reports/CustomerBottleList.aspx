<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerBottleList.aspx.cs" Inherits="Enterprise.IIS.business.Reports.CustomerBottleList" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FKeyId" HeaderText="单据号" SortField="FKeyId" />
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FQty" HeaderText="当日发生" SortField="FQty" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" DataField="FAmount" HeaderText="当日欠瓶" SortField="FAmount" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" DataField="FAmt" HeaderText="累计欠瓶" SortField="FAmt" TextAlign="Right" />
