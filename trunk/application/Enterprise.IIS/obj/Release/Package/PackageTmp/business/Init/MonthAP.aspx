<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthAP.aspx.cs" Inherits="Enterprise.IIS.business.Init.MonthAP" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>供应商月期初账款</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            ...
            <Regions>
                <f:Region ID="Region1" Title="客户月期初账款" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FAmt" HeaderText="应付款" SortField="FAmt" TextAlign="Right" />
                                            </Columns>
                                            <PageItems>
