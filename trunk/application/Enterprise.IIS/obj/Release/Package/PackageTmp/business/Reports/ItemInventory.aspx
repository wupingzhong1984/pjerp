<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ItemInventory.aspx.cs" Inherits="Enterprise.IIS.business.Reports.ItemInventory" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                ...
                <f:Region ID="Region1" Title="商品库存" Position="Center"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList ID="ddlType" runat="server" Label="产品类型"
                                                             EnableEdit="False" Enabled="False" Hidden="True">
                                                            <f:ListItem Text="配件产品" Value="2002"  Selected="true" />
                                                        </f:DropDownList>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20000" ShowBorder="false" ShowHeader="false" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px"  ColumnID="FInitQty" DataField="FInitQty" HeaderText="当日期初" SortField="FInitQty" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" ColumnID="FInQty" DataField="FInQty" HeaderText="当日收入" SortField="FInQty" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" ColumnID="FOutQty" DataField="FOutQty" HeaderText="当日支出" SortField="FOutQty" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px"  ColumnID="FEndQty" DataField="FEndQty" HeaderText="当日结余" SortField="FEndQty" TextAlign="Right" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
