<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="D.aspx.cs" Inherits="Enterprise.IIS.business.TubeSales.D" %>
                    ...
                    <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                        ...
                        <Rows>
                            ...
                            <f:FormRow ID="FormRow6">
                                <Items>
                                    <f:TextBox ID="txtFPayTemperature" runat="server" Label="交付温度(°C)"
                                        LabelAlign="Right">
                                    </f:TextBox>
                            ...
                            <f:FormRow ID="FormRow7">
                                <Items>
                                    <f:TextBox ID="txtFReceiveTemperature" runat="server" Label="接收温度(°C)"
                                        LabelAlign="Right">
                                    </f:TextBox>
                            ...
                            <f:FormRow ID="FormRow8" Hidden="true">
                                <Items>
