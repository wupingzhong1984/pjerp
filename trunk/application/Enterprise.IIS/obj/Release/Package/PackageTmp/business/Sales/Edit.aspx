<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.Sales.Edit" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20"
                                            ...
                                            <Columns>
                                                ...
                                                <f:RenderField MinWidth="100px" ColumnID="FBottleOutCode" DataField="FBottleOutCode" FieldType="String" TextAlign="Right"
                                                    HeaderText="发出容器编号">
                                                    <Editor>
                                                        <f:TextBox ID="tbxFBottleOutCode" Required="true" runat="server">
                                                        </f:TextBox>
                                                    </Editor>
                                                </f:RenderField>
                                                ...
                                                <f:RenderField MinWidth="100px" ColumnID="FBottleInCode" DataField="FBottleInCode" FieldType="String" TextAlign="Right"
                                                    HeaderText="收入容器编号">
                                                    <Editor>
                                                        <f:TextBox ID="tbxFBottleInCode" Required="true" runat="server">
                                                        </f:TextBox>
                                                    </Editor>
                                                </f:RenderField>
