<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.FinanceFKChecked.Edit" %>
...
<body>
    <form id="form1" runat="server">
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="106px" EnableCollapse="True">
                                    <Items>
                                ...
                                <f:Region ID="Region5" ShowBorder="False" ShowHeader="false" Position="Bottom" RegionSplit="False"
        ...
        <f:Window ID="Window2" runat="server" WindowPosition="Center" IsModal="true"
            ...
            Target="Parent" EnableIFrame="true" Title="选择供应商列表"
        ...
        <f:Window ID="Window3" runat="server" WindowPosition="Center" IsModal="true"
            Icon="ApplicationViewDetail" EnableMaximize="true" EnableResize="true" Hidden="True" EnableClose="true"
            Target="Parent" EnableIFrame="true" Title="选择供应商地址"
            IFrameUrl="about:blank" Height="450px" Width="800px" OnClose="Window1_Close">
        </f:Window>
    </form>
