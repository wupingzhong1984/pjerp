<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthStockBottleDetails.aspx.cs" Inherits="Enterprise.IIS.business.Reports.MonthStockBottleDetails" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>容器存货库存流水清单</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="容器存货库存流水清单" Position="Center"
