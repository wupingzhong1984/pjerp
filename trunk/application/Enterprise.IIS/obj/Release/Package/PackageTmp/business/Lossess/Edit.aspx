<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.Lossess.Edit" %>
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFCate" Label="盘亏类型" LabelAlign="Right"  Required="True" ShowRedStar="True" EnableEdit="True" />
                                                    </Items>
                                                </f:FormRow>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    runat="server" BodyPadding="3px" AutoScroll="True" Layout="Fit">
                                    <Items>
