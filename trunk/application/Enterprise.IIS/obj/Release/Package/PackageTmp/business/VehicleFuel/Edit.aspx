<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.VehicleFuel.Edit" %>
                ...
                <f:Region ID="Region1" Title="出仓单" Position="Center"
                    ...
                    <Items>
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="True" Title="编辑出仓单" Split="False"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:DatePicker ID="txtFDate" runat="server" Required="false" Label="加油日期" EmptyText="日期"
                                                            ShowRedStar="false">
                                                        </f:DatePicker>
                                                        
                                                        <f:TextBox Required="True" ID="txtFAmount" runat="server" Label="加油数量（L）" EmptyText=""  >
                                                        </f:TextBox>
                                                ...
                                                <f:FormRow ID="FormRow5">
                                                    <Items>
                                                        <f:TextBox Required="True" ID="txtFAmt" runat="server" Label="加油公里数" >
                                                        </f:TextBox>
                                                        <f:DropDownList runat="server" ID="ddlFDriver" Label="司机签字" EnableEdit="True" EnableMultiSelect="true" LabelAlign="Right" />
                                                        <f:DropDownList runat="server" ID="ddlFShipper" Label="仓库签字" EnableEdit="True" LabelAlign="Right" />
                                                        <f:TextBox ID="txtFBarcode" runat="server" Label="开锁签字" EmptyText="" >
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow6">
                                                    <Items>
                                                        <f:DatePicker ID="dataFUpdateDate" runat="server" Required="false" Label="长途开锁日期" EmptyText="日期"
                                                            ShowRedStar="false">
                                                        </f:DatePicker>
                                                        <f:DropDownList  Required="True" runat="server" ID="ddlFVehicleNum" Label="车牌号" EnableEdit="True" LabelAlign="Right" />
