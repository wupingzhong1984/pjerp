<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerMonthBottle.aspx.cs" Inherits="Enterprise.IIS.business.Reports.CustomerMonthBottle" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px"  ColumnID="FBCode"  DataField="FBCode" HeaderText="包装物" SortField="FBCode" />
                                                <f:BoundField MinWidth="120px"  ColumnID="FBName"  DataField="FBName" HeaderText="包装物" SortField="FBName" />
                                                
                                                <f:BoundField MinWidth="120px"  ColumnID="FInitAR" DataField="FInitAR" HeaderText="期初占用" SortField="FInitAR" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px"  ColumnID="FPeriodAR"  DataField="FPeriodAR" HeaderText="本期发出" SortField="FPeriodAR" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px"  ColumnID="FPeriodReturn"  DataField="FPeriodReturn" HeaderText="本期退货" SortField="FPeriodReturn" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px"  ColumnID="FPeriodRecover"  DataField="FPeriodRecover" HeaderText="本期收回" SortField="FPeriodRecover" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px"  ColumnID="FFinalAR"  DataField="FFinalAR" HeaderText="期未占用" SortField="FFinalAR" TextAlign="Center" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
