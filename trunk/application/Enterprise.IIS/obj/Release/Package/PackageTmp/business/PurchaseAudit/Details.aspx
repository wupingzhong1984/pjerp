<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.PurchaseAudit.Details" %>
                                        ...
                                        <f:TabStrip ID="TabStrip1" AutoPostBack="true" ShowBorder="false" ActiveTabIndex="0" runat="server">
                                            <Tabs>
                                                ...
                                                <f:RenderField MinWidth="130px" ColumnID="FBottleName" DataField="FBottleName"
                                                    HeaderText="包装物">
                                                    <Editor>
                                                        <f:DropDownList ID="DropDownList1" Required="true" runat="server" Enabled="True" EnableEdit="True">
                                                        </f:DropDownList>
                                                    </Editor>
                                                </f:RenderField>
