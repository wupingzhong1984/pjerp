<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FSalesPlanCompare.aspx.cs" Inherits="Enterprise.IIS.business.Reports.FSalesPlanCompare" %>
                    ...
                    <Items>
                        <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" LabelWidth="80px" EnableCollapse="False"
                            ...
                            <Items>
                                ...
                                <f:TextBox runat="server" ID="txtFSalesman" Label="业务员" />--%>
                            </Items>
                        </f:SimpleForm>
                    </Items>
                </f:Region>
                                ...
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="False" Split="False"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="130px" ColumnID="FLogisticsNumber" DataField="FLogisticsNumber" HeaderText="订单号" SortField="FLogisticsNumber" />
                                                ...
                                                <f:BoundField MinWidth="120px" ColumnID="FUnit" DataField="FUnit" HeaderText="单位" SortField="FUnit" />
                                                <f:BoundField MinWidth="80px" ColumnID="FPlanQty" DataField="FPlanQty" HeaderText="订货量" SortField="FPlanQty" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" ColumnID="FQty" DataField="FQty" HeaderText="实发量" SortField="FQty" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" ColumnID="FDiffQty" DataField="FDiffQty" HeaderText="相差数" SortField="FDiffQty" TextAlign="Right" />
