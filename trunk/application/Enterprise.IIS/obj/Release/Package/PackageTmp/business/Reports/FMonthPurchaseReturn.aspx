<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMonthPurchaseReturn.aspx.cs" Inherits="Enterprise.IIS.business.Reports.FMonthPurchaseReturn" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="110px" ColumnID="FBottleName"  DataField="FBottleName" HeaderText="包装物编码" SortField="FBottleName" />
                                                <f:BoundField MinWidth="80px" ColumnID="FBottleQty"  DataField="FBottleQty" HeaderText="实瓶数量" SortField="FBottleQty"  TextAlign="Right"/>
                                                <f:BoundField MinWidth="80px" ColumnID="FRecycleQty"  DataField="FRecycleQty" HeaderText="回空数量" SortField="FRecycleQty"  TextAlign="Right"/>
