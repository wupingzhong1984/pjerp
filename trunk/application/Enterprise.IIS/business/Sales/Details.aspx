<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.Sales.Details" %>
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="5px" runat="server" Height="188px" EnableCollapse="True">
                                    <Items>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:Label ID="txtFDate" runat="server" Label="日期" LabelAlign="Right">
                                                        </f:Label>
                                                        <f:Label ID="txtFReconciliation" runat="server" Label="对账单号" LabelAlign="Right" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        <f:Label runat="server" Label="客户代码" ID="txtFCode" LabelAlign="Right" />
                                                        <f:Label ID="tbxFCustomer" Label="客户名称" runat="server" LabelAlign="Right">
                                                        </f:Label>
                                                        <f:Label ID="txtFAddress" Label="客户地址" runat="server" LabelAlign="Right">
                                                        </f:Label>
                                                        <f:Label ID="txtFPhone" runat="server" Label="电话" LabelAlign="Right">
                                                        </f:Label>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:Label ID="txtFLinkman" runat="server" Label="联系人" LabelAlign="Right">
                                                        </f:Label>
                                                        <f:Label ID="txtFFreight" runat="server" Label="运输服务费" LabelAlign="Right">
                                                        </f:Label>
                                                ...
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        ...
                                                        <f:Label runat="server" ID="ddlFShipper" Label="发货人" LabelAlign="Right" />
                                                        <f:Label runat="server" ID="ddlFArea" Label="区域" LabelAlign="Right" />
                                                        <f:Label runat="server" ID="ddlFSalesman" Label="业务员" LabelAlign="Right" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow4">
                                                    <Items>
                                                        <f:Label runat="server" ID="ddlDeliveryMethod" Label="配送方式" LabelAlign="Right" />
                                                        <f:Label ID="txtFLogisticsNumber" runat="server" Label="物流单号" LabelAlign="Right">
                                                        </f:Label>
                                                        <f:Label ID="txtFAmount" runat="server" Label="应收金额" LabelAlign="Right">
                                                        </f:Label>
                                                        <f:Label ID="txtFAmt" runat="server" Label="实收金额" LabelAlign="Right">
                                                        </f:Label>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow5">
                                                    <Items>
                                                       <f:Label ID="lblfile" Label="附件" EncodeText="false" runat="server" LabelAlign="Right"></f:Label>
                                                        <f:Label ID="txtFMemo" runat="server" Label="备注" LabelAlign="Right">
                                                        </f:Label>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                                    ...
                                                    <Items>
                                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <f:RenderField MinWidth="100px" ColumnID="FReturnQty" DataField="FReturnQty" FieldType="Int" TextAlign="Right"
                                                                    HeaderText="商品收入数">
                                                                    <Editor>
                                                                ...
                                                                <f:RenderField MinWidth="100px" ColumnID="FEmptyBottle" DataField="FEmptyBottle" FieldType="Int" TextAlign="Right"
                                                    HeaderText="空瓶数">
                                                    <Editor>
                                                        <f:TextBox ID="tbxFEmptyBottle" Required="true" runat="server">
                                                        </f:TextBox>
                                                    </Editor>
                                                </f:RenderField>
