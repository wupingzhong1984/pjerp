<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.Customer.Index" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Toolbars>
                <f:Toolbar ID="Toolbar1" runat="server">
                    <Items>
                        ...
                        <f:Button ID="btnAdd" Enabled="true" runat="server" Text="新增" Icon="Add" Hidden="True" Size="Medium">
                        </f:Button>
                        <f:Button ID="btnAddLink" OnClick="btnAddLink_Click"  runat="server" Text="联系地址" Icon="MapAdd" Hidden="False" Size="Medium">
                        </f:Button>
            ...
            <Regions>
                ...
                <f:Region ID="Region2" Title="客户管理" Position="Center"  ShowBorder="False"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="100px" DataField="FSalesman" HeaderText="业务员" SortField="FSalesman" />
