<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.FinanceSKChecked.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="核销收款单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="核销收款单"/>
                                <f:ToolbarSeparator ID="ToolbarSeparator2" runat="server" />
                                <f:Button ID="btnSearch" OnClick="btnSearch_Click" runat="server" Text="查询" Icon="Zoom" Hidden="False" Size="Medium">
                                </f:Button>
                                <f:Button ID="btnAdd" runat="server" OnClientClick="openAddUI();" Text="收款核销" Icon="Calculator" Hidden="True" Size="Medium">
                                </f:Button>
                                ...
                                <%--<f:Button ID="btnCopy" OnClick="btnCopy_Click" runat="server" Text="复制"
                                    Icon="PageCopy" Hidden="False" Size="Medium">
                                </f:Button>--%>
                                <f:Button ID="btnAudit" OnClick="btnAudit_Click" runat="server" Text="审核"
                                    Icon="PageAttach" Hidden="False" Size="Medium">
                                </f:Button>
                                <%--<f:Button ID="btnUnAudit" runat="server" Text="反审核"
                                    Icon="PageCancel" Hidden="False" Size="Medium">
                                </f:Button>--%>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/FinanceSKChecked/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【核销收款单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/FinanceSKChecked/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加核销收款单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/FinanceSKChecked/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑核销收款单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
