<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthUnitBottle.aspx.cs" Inherits="Enterprise.IIS.business.Init.MonthUnitBottle" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>单位月期初钢瓶占用情况</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            ...
            <Regions>
                <f:Region ID="Region1" Title="单位月期初钢瓶占用情况" Position="Center"
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="50px" EnableCollapse="True">
                                    <Items>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DatePicker ID="dateBegin" runat="server" Label="年月"  LabelAlign="Right" DateFormatString="yyyy-MM">
                                                        </f:DatePicker>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="true"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="80px" DataField="FDate" HeaderText="年月" SortField="FDate" DataFormatString="{0:yyyy-MM}" TextAlign="Center" />
                                                ...
                                                <f:BoundField MinWidth="100px" DataField="FCate" HeaderText="客户名称" SortField="FCate" />
                                                <f:BoundField MinWidth="100px" DataField="FItemCode" HeaderText="钢瓶编码" SortField="FItemCode" />
                                                <f:BoundField MinWidth="100px" DataField="FItemName" HeaderText="钢瓶名称" SortField="FItemName" />
                                                <f:BoundField MinWidth="100px" DataField="FSpec" HeaderText="规格" SortField="FSpec" />
                                                <f:BoundField MinWidth="80px" DataField="FUnit" HeaderText="单位" SortField="FUnit" />
                                                <f:BoundField MinWidth="120px" DataField="FInitQty" HeaderText="占用量" SortField="FInitQty" TextAlign="Right" />
                                            </Columns>
                                            <PageItems>
