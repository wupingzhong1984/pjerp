<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="InitSupplierAP.aspx.cs" Inherits="Enterprise.IIS.business.Init.InitSupplierAP" %>


<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>初始供应商应付账款</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" ShowBorder="False" ShowHeader="False" Title="初始供应商应付账款" Position="Center"
                                    ...
                                    <Items>
                                        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="135px" EnableAjax="true"
                                            ...
                                            <Items>
                                                <f:GroupPanel runat="server" Title="模版下载" ID="GPanelRoleInfo" EnableCollapse="True">
                                                    <Items>
                                                        ...
                                                        <f:ContentPanel ID="ContentPanel1" ShowBorder="false" BodyPadding="10px" ShowHeader="false"
                                                            ...
                                                            <a href="~/business/template/初始供应商账款.xls" runat="server">下载模版</a>
                                                        </f:ContentPanel>
                                                    </Items>
                                                </f:GroupPanel>
                                                ...
                                                <f:Grid ID="Grid1" Title="初始供应商应付账款" ShowBorder="false" ShowHeader="False"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <f:BoundField Width="100px" DataField="应付账款" HeaderText="应付账款" SortField="应付账款" />
                                                    </Columns>
                                                </f:Grid>
                                            </Items>
                                        </f:SimpleForm>
