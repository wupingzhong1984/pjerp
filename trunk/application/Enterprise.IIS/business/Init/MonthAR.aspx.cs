...
{
    public partial class MonthAR : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        ///     数据服务
        /// </summary>
        private ViewMonthARService _viewMonthArService;

        /// <summary>
        ///     数据服务
        /// </summary>
        protected ViewMonthARService ViewMonthARService
        {
            get { return _viewMonthArService ?? (_viewMonthArService = new ViewMonthARService()); }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=客户应收胀库{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            Expression<Func<vm_MonthAR, bool>> predicate = BuildPredicate(out orderingSelector);

            //取数据源
            IQueryable<vm_MonthAR> list = ViewMonthARService.Where(predicate, Grid1.PageSize, Grid1.PageIndex + 1,
        ...
        /// <returns></returns>
        private Expression<Func<vm_MonthAR, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            // 查询条件表达式
            Expression expr = Expression.Constant(true);

            ParameterExpression parameter = Expression.Parameter(typeof(vm_MonthAR));
            ...
            string date = Convert.ToDateTime(dateBegin.SelectedDate).ToString("yyyy-MM");
            ...
            Expression<Func<vm_MonthAR, bool>> predicate = Expression.Lambda<Func<vm_MonthAR, bool>>(expr, parameter);
