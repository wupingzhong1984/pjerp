...
{
    public partial class MonthUnitBottle : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        ///     数据服务
        /// </summary>
        private ViewMonthBottleService _viewMonthArService;

        /// <summary>
        ///     数据服务
        /// </summary>
        protected ViewMonthBottleService ViewMonthBottleService
        {
            get { return _viewMonthArService ?? (_viewMonthArService = new ViewMonthBottleService()); }
            set { _viewMonthArService = value; }
        }
        ...
        private void BindDataGrid()
        {
            ...
            Expression<Func<vm_MonthBottle, bool>> predicate = BuildPredicate(out orderingSelector);

            //取数据源
            IQueryable<vm_MonthBottle> list = ViewMonthBottleService.Where(predicate, Grid1.PageSize, Grid1.PageIndex + 1,
        ...
        /// <returns></returns>
        private Expression<Func<vm_MonthBottle, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            // 查询条件表达式
            Expression expr = Expression.Constant(true);

            ParameterExpression parameter = Expression.Parameter(typeof(vm_MonthBottle));
            ...
            Expression<Func<vm_MonthBottle, bool>> predicate = Expression.Lambda<Func<vm_MonthBottle, bool>>(expr, parameter);
