<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthStock.aspx.cs" Inherits="Enterprise.IIS.business.Init.MonthStock" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>本厂月期初产品情况</title>
...
<body>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFCode" runat="server" Label="商品代码"  LabelAlign="Right">
                                                        </f:TextBox>
                                                        <f:TextBox ID="txtFName" runat="server" Label="商品名称"  LabelAlign="Right">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FInitQty" HeaderText="数量" SortField="FInitQty" TextAlign="Right" />
                                            </Columns>
                                            <PageItems>
    ...
    <script type="text/javascript">
        ...
        function openAddFineUI(url) {
            parent.addExampleTab.apply(null, ['add_fineui_pars', basePath + url, '引入产品期初数量', basePath + 'icon/database_add.png', true]);
        }
