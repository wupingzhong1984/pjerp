<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.Lease.Details" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                ...
                <f:Region ID="Region1" Title="气瓶租金单" Position="Center"
                                                        ...
                                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                                            ...
                                                            <Columns>
                                                                <f:RenderField MinWidth="100px" ColumnID="FBottle" DataField="FBottle" FieldType="String"
                                                                    HeaderText="编码">
                                                                    <Editor>
                                                                        <f:TextBox ID="tbxFBottle" Required="true" runat="server">
                                                                        </f:TextBox>
                                                                    </Editor>
                                                                </f:RenderField>
                                                                ...
                                                                <f:RenderField MinWidth="100px" ColumnID="FRentDay" DataField="FRentDay" FieldType="Double" TextAlign="Right"
                                                                    HeaderText="租金/日">
                                                                    <Editor>
                                                                        <f:TextBox ID="tbxFRentDay" Required="true" runat="server">
                                                                        </f:TextBox>
                                                                    </Editor>
                                                                </f:RenderField>
                                                                <f:BoundField MinWidth="80px" DataField="FReturnQty" TextAlign="Right" HeaderText="已回收" />
