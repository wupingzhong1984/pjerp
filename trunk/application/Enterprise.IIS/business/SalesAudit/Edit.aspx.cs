    ...
    public partial class Edit : PageBase
    {
        ...
        private bool SubmintEdit()
        {
            if (StockOut != null)
            {
                ...
                StockOut.FDiscountAmount = 0;//string.IsNullOrEmpty(txtFDiscountAmount.Text.Trim()) ? 0 : Convert.ToDecimal(txtFDiscountAmount.Text.Trim());
                ...
                //---------------------------------------------------------
                StockOut.FT6Date = txtFT6Date.SelectedDate;
                //收发类型
                ...
                //T6同步
                StockOut.FT6Status = ddlT6Status.SelectedValue;
        ...
        private bool SubmintAdd()
        {
            ...
            if (stock != null)
            {
                ...
                stock.FDiscountAmount = 0;//string.IsNullOrEmpty(txtFDiscountAmount.Text.Trim()) ? 0 : Convert.ToDecimal(txtFDiscountAmount.Text.Trim());
                ...
                //---------------------------------------------------------
                //收发类型
                stock.FT6Date = txtFT6Date.SelectedDate;
                ...
                //T6同步
                stock.FT6Status = ddlT6Status.SelectedValue;
            ...
            switch (Actions)
            {
                ...
                case WebAction.Edit:
                    ...
                    if (StockOut != null)
                    {
                        ...
                        ddlT6Status.SelectedValue = StockOut.FT6Status;
                        ddlFDistributionPoint.SelectedValue = StockOut.FDistributionPoint;

                        txtFT6Date.SelectedDate = StockOut.FT6Date;
