<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.Produce.Index" %>
...
<body>
                                        ...
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:TemplateField Width="100px" HeaderText="单据状态" TextAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblStatus" runat="server" Text='<%# EnumDescription.GetFieldText((GasEnumAuditFlag) Eval("FAuditFlag")) %>'></asp:Label>
                                                    </ItemTemplate>
                                                </f:TemplateField>
    ...
    <script type="text/javascript">
        ...
        function openAddUI() {
            var url = 'business/Produce/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加领料单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Produce/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑领料单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
