<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.Produce.Details" %>
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="5px" runat="server" Height="108px" EnableCollapse="True">
                                    <Items>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:Label ID="txtFDate" runat="server" Label="领料日期"
                                                            ShowRedStar="false">
                                                        </f:Label>
                                                        <f:Label runat="server" ID="txtFCate" Label="出仓类型" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlOrgnization" Label="领用部门" Readonly="true"  />
                                                        <f:Label ID="txtFLinkman" runat="server" Label="领用人">
                                                        </f:Label>
                                                        <f:DropDownList runat="server" ID="ddlT6ReceiveSendType" Label="收发类型" Readonly="true"  />
                                                        <f:Label runat="server" ID="txtFWarehouse" Label="仓库" />
                                                    </Items>
                                                </f:FormRow>

                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        <f:Label runat="server" ID="txtFReceiver" Label="发货人" />
                                                        <f:Label runat="server" ID="txtFGroup" Label="班组" />
                                                        <f:Label runat="server" ID="txtFDistributionPoint" Label="作业区"  />
                                                    
                                                        <f:Label runat="server" ID="txtFMemo" Label="备注"></f:Label>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
