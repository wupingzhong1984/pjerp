<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.FinanceFK.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="付款单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items> 
                                <f:Label runat="server" ID="headerText" Text="付款单"/>
                                <f:ToolbarSeparator ID="ToolbarSeparator2" runat="server" />
                                <f:Button ID="btnSearch" OnClick="btnSearch_Click" runat="server" Text="查询" Icon="Zoom" Hidden="False" Size="Medium">
                                </f:Button>
                                <f:Button ID="btnAdd" runat="server" OnClientClick="openAddUI();" Text="付款" Icon="CoinsDelete" Hidden="True" Size="Medium">
                                </f:Button>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/FinanceFK/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '【付款单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/FinanceFK/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '添加付款单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/FinanceFK/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '【编辑付款单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
