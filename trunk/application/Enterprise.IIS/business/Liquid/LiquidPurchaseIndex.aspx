<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidPurchaseIndex.aspx.cs" Inherits="Enterprise.IIS.business.Liquid.LiquidPurchaseIndex" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="液体采购" Position="Center"
                    ShowBorder="False" BoxConfigAlign="Stretch" Layout="Fit" runat="server" ShowHeader="False">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="采购单" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/Liquid/LiquidPurchaseDetails.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【采购单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Liquid/LiquidPurchaseEdit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00003', basePath + url, '添加采购单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Liquid/LiquidPurchaseEdit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00003', basePath + url, '【编辑采购单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
