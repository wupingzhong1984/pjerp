<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidPlan.aspx.cs" Inherits="Enterprise.IIS.business.Liquid.LiquidPlan" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="液体进销" Position="Center"
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="50" MinHeight="220px" ShowBorder="False" 
                                            ...
                                            runat="server" DataKeyNames="KeyId,FMarginEnd"
                                            ...
                                            <Columns>
                                                ...
                                                <f:GroupField HeaderText="基本信息" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        ...
                                                        <f:RenderField Width="100px" ColumnID="FVehicleNum" DataField="FVehicleNum" FieldType="String"
                                                            HeaderText="车牌号">
                                                            <Editor>
                                                        ...
                                                        <%--<f:RenderField Width="160px" ColumnID="FDriver" DataField="FDriver" FieldType="String"
                                                            HeaderText="司机">
                                                            <Editor>
                                                                <f:DropDownList ID="tbxFDriver"  runat="server"  EnableMultiSelect="True"  Enabled="False">
                                                                </f:DropDownList>
                                                            </Editor>
                                                        </f:RenderField>--%>
                                                        ...
                                                        <f:RenderField Width="100px" ColumnID="FSupercargo" DataField="FSupercargo" FieldType="String"
                                                            HeaderText="押运员">
                                                            <Editor>
                                                ...
                                                <f:GroupField HeaderText="采购" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        ...
                                                        <f:RenderField MinWidth="220px" ColumnID="FSupplierName" DataField="FSupplierName" FieldType="String" TextAlign="Left"
                                                            HeaderText="供应商">
                                                            <Editor>
                                                ...
                                                <f:GroupField HeaderText="销售" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        <f:RenderField MinWidth="100px" ColumnID="FDate1" DataField="FDate1" 
                                                        ...
                                                        <f:RenderField MinWidth="220px" ColumnID="FName1" DataField="FName1" FieldType="String" TextAlign="Left"
                                                            HeaderText="客户">
                                                            <Editor>
                                                        ...
                                                        <f:RenderField MinWidth="100px" ColumnID="FPrice1" DataField="FPrice1" FieldType="Double" TextAlign="Right"
                                                            HeaderText="价格">
                                                            <Editor>
                                                        ...
                                                        <f:RenderField MinWidth="100px" ColumnID="FPQty1" DataField="FPQty1" FieldType="Double" TextAlign="Right"
                                                            HeaderText="计划量">
                                                            <Editor>
                                                ...
                                                <f:GroupField HeaderText="销售" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        ...
                                                        <f:RenderField MinWidth="100px" ColumnID="FDate2" DataField="FDate2" 
                                                            FieldType="String" TextAlign="Left"
                                                            HeaderText="卸车时间" Hidden="True">
                                                            <Editor>
                                                                <f:TextBox ID="dpFDate2" LabelAlign="Right" 
                                                                    EmptyText="卸车时间" runat="server">
                                                                </f:TextBox>
                                                            </Editor>
                                                        </f:RenderField>
                                                        ...
                                                        <f:RenderField MinWidth="220px" ColumnID="FName2" DataField="FName2" FieldType="String" TextAlign="Left"
                                                            HeaderText="客户">
                                                            <Editor>
                                                                <f:DropDownList ID="tbxFName2" runat="server" EnableEdit="True">
                                                                </f:DropDownList>
                                                            </Editor>
                                                        </f:RenderField>
                                                        

                                                        <f:RenderField MinWidth="100px" ColumnID="FPrice2" DataField="FPrice2" FieldType="Double" TextAlign="Right"
                                                            HeaderText="价格">
                                                            <Editor>
                                                                <f:NumberBox ID="tbxFPrice2"  runat="server">
                                                                </f:NumberBox>
                                                            </Editor>
                                                        </f:RenderField>
                                                        
                                                        <f:RenderField MinWidth="100px" ColumnID="FPQty2" DataField="FPQty2" FieldType="Double" TextAlign="Right"
                                                            HeaderText="计划量">
                                                            <Editor>
                                                                <f:NumberBox ID="NumberBox3"  runat="server">
                                                                </f:NumberBox>
                                                            </Editor>
                                                        </f:RenderField>

                                                        <f:RenderField MinWidth="100px" ColumnID="FQty2" DataField="FQty2" FieldType="Double" TextAlign="Right"
                                                            HeaderText="磅单量">
                                                            <Editor>
                                                                <f:NumberBox ID="tbxFQty2"  runat="server">
                                                                </f:NumberBox>
                                                            </Editor>
                                                        </f:RenderField>
                                                        
                                                        
                                                        <f:BoundField MinWidth="120px" DataField="FAmt2" HeaderText="金额" SortField="FAmt2" TextAlign="Right"/>
                                                ...
                                                <f:GroupField HeaderText="销售" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        ...
                                                        <f:RenderField MinWidth="100px" ColumnID="FDate3" DataField="FDate3" 
                                                            FieldType="String" TextAlign="Left"
                                                            HeaderText="卸车时间" Hidden="True">
                                                            <Editor>
                                                                <f:TextBox ID="dpFDate3" LabelAlign="Right"
                                                                    EmptyText="卸车时间" runat="server">
                                                                </f:TextBox>
                                                            </Editor>
                                                        </f:RenderField>
                                                        ...
                                                        <f:RenderField MinWidth="220px" ColumnID="FName3" DataField="FName3" FieldType="String" TextAlign="Left"
                                                            HeaderText="客户">
                                                            <Editor>
                                                                <f:DropDownList ID="tbxFName3" runat="server" EnableEdit="True">
                                                                </f:DropDownList>
                                                            </Editor>
                                                        </f:RenderField>
                                                        

                                                        <f:RenderField MinWidth="100px" ColumnID="FPrice3" DataField="FPrice3" FieldType="Double" TextAlign="Right"
                                                            HeaderText="价格">
                                                            <Editor>
                                                                <f:NumberBox ID="tbxFPrice3"  runat="server">
                                                                </f:NumberBox>
                                                            </Editor>
                                                        </f:RenderField>
                                                        
                                                        <f:RenderField MinWidth="100px" ColumnID="FPQty3" DataField="FPQty3" FieldType="Double" TextAlign="Right"
                                                            HeaderText="计划量">
                                                            <Editor>
                                                                <f:NumberBox ID="NumberBox4"  runat="server">
                                                                </f:NumberBox>
                                                            </Editor>
                                                        </f:RenderField>
                                                        <f:RenderField MinWidth="100px" ColumnID="FQty3" DataField="FQty3" FieldType="Double" TextAlign="Right"
                                                            HeaderText="磅单量">
                                                            <Editor>
                                                                <f:NumberBox ID="tbxFQty3"  runat="server">
                                                                </f:NumberBox>
                                                            </Editor>
                                                        </f:RenderField>
                                                        <f:BoundField MinWidth="120px" DataField="FAmt3" HeaderText="金额" SortField="FAmt3" TextAlign="Right"/>
                                                    </Columns>
                                                </f:GroupField>
