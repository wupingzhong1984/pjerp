<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidMarginRpt.aspx.cs" Inherits="Enterprise.IIS.business.Liquid.LiquidMarginRpt" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="槽车余量表" Position="Center"
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="False" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="160px" DataField="FNum" HeaderText="槽车" SortField="FNum" />
                                                <f:BoundField MinWidth="80px" ColumnID="FMargin" DataField="FMargin" HeaderText="余量" SortField="FMargin"  TextAlign="Right" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
