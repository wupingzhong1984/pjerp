...
namespace Enterprise.IIS.business.Liquid
{
    ...
    ///     液体进销
    /// </summary>
    public partial class LiquidPlan : PageBase
    {
        /// <summary>
        ///     AppendToEnd
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=液体进销{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            var list = SqlService.ExecuteProcedureCommand("proc_LiquidPlanList", parms).Tables[0];
