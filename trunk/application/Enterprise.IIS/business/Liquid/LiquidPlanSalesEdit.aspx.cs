...
{
    public partial class LiquidPlanSalesEdit : PageBase
    {
        #region  Service
        ...
        //        var details = LiquidPlanTaskDetailsService.Where(p => p.FId == datakey).FirstOrDefault();
        //        //写入原始，通过存储过程完成明细复制
        ...
        //        LiquidPlanTaskDetailsService.SaveChanges();
        //    }
        //}
        ...
        private bool SubmintAdd()
        {
            ...
            if (stock != null)
            {
                ...
                {
                    //单据号问题
                    string newKeyId = SequenceService.CreateSequence(Convert.ToDateTime(txtFDate.SelectedDate), "CX", CurrentUser.AccountComId);
                    var orderParms = new Dictionary<string, object>();
                    orderParms.Clear();
                    orderParms.Add("@oldKeyId", txtKeyId.Text);
                    orderParms.Add("@newKeyId", newKeyId);
                    orderParms.Add("@Bill", "30");
            ...
            switch (Actions)
            {
                case WebAction.Add:
                    ...
                    var temp = new LHLiquidPlanTask
                    {
                        ...
                        //发货单
                        FType = Convert.ToInt32(GasEnumBill.LiquidSalesPlan),
                ...
                case WebAction.Edit:
                    ...
                    if (LiquidPlanTask != null)
                    {
                        ...
                        tbxFItemName.SelectedValue = LiquidPlanTask.FItemCode;
