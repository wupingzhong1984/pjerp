<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidPlanSales.aspx.cs" Inherits="Enterprise.IIS.business.Liquid.LiquidPlanSales" %>
...
<body>
                                                ...
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFStatus" Label="业务状态" EnableEdit="True" LabelAlign="Right"> 
                                                            ...
                                                            <f:ListItem Text="已制单" Value="0" />
                                                            <f:ListItem Text="已配车" Value="1" />
                                                            </f:DropDownList>
                                                    </Items>
                                                </f:FormRow>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/Liquid/LiquidPlanSalesDetails.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【液体销售订单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Liquid/LiquidPlanSalesEdit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加液体销售订单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Liquid/LiquidPlanSalesEdit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑液体销售订单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
