...
{
    public partial class LiquidMarginRpt : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        protected string SortField
        {
            get
            {
                string sort = ViewState["SortField"] != null ? ViewState["SortField"].ToString() : "FNum";
                return sort;
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=槽车余量表{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            var list = SqlService.ExecuteProcedureCommand("rpt_LiquidMargin", parms).Tables[0];
            ...
            if (list != null && list.Rows.Count > 0)
            {
                ...
                var summary = new JObject
                    {
                        {"FNum", "合计"},
                        {"FMargin", list.Compute("sum(FMargin)","true").ToString()},
                    };
