<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.SalesPlanLogic.Edit" %>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow6">
                                                    <Items>
                                                        ...
                                                        <%--<f:DropDownList runat="server" ID="ddlFAddress" Label="地址" EnableEdit="true" LabelAlign="Right" >
                                                        </f:DropDownList>--%>
                                                        <f:TextBox ID="txtFAddress" runat="server" Label="地址" LabelAlign="Right">
                                                        </f:TextBox>
