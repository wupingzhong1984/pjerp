<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.PurchaseReturn.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="采购退货单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="采购退货单"/>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/PurchaseReturn/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【采购退货单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/PurchaseReturn/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00002', basePath + url, '添加采购退货单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/PurchaseReturn/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00002', basePath + url, '【编辑采购退货单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
