<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.SalesT6Upload.Index" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="未上传T6提货单" Position="Center"
                    ShowBorder="False" BoxConfigAlign="Stretch" Layout="Fit" runat="server" ShowHeader="False" Icon="Page">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="上传发货单"/>
                                <f:ToolbarSeparator ID="ToolbarSeparator2" runat="server" />
                                <f:Button ID="btnSearch" OnClick="btnSearch_Click" ValidateForms="SimpleForm1" runat="server" Text="查询" Icon="Zoom" Hidden="False" Size="Medium">
                                </f:Button>
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFSalesman" Required="True" 
                                                            Label="业务员" EnableEdit="True" LabelAlign="Right" />
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    Layout="Fit" runat="server" BodyPadding="1px" AutoScroll="True">
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            runat="server" EnableCheckBoxSelect="True" DataKeyNames="KeyId,FFlag,FT6Status,FSalesman" OnPageIndexChange="Grid1_PageIndexChange"
                                            ...
                                            <Columns>
                                                <f:LinkButtonField Width="120px"  ColumnID="KeyId" CommandName="actView" DataTextField="KeyId" HeaderText="发货单号" SortField="KeyId" TextAlign="Center" runat="server" />
                                                <f:BoundField MinWidth="125px" DataField="FLogisticsNumber" HeaderText="订单号" SortField="FLogisticsNumber" />
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FFreight" HeaderText="运输服务费" Hidden="true" SortField="FFreight" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FAmount" HeaderText="货款" Hidden="true"  SortField="FAmount" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FAmt" HeaderText="实收款" Hidden="true"  SortField="FAmt" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FSubjectName" HeaderText="收款账户" Hidden="true"  SortField="FSubjectName" TextAlign="Left" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/SalesAudit/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑复核发货单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
        function openAddUI() {
            var url = 'business/SalesAudit/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加复核发货单', basePath + 'icon/page_add.png', true]);
        };
