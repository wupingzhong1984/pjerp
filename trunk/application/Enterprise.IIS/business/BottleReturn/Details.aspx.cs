        ...
        private void LoadData()
        {
            switch (Actions)
            {
                case WebAction.Details:
                    if (StockIn != null)
                    {
                        lblKeyId.Text = StockIn.KeyId;

                        lblCustomer.Text = StockIn.FName;
                        lblFAddress.Text = StockIn.FAddress;
                        lblFFreight.Text = StockIn.FFreight.ToString();
                        lblFLinkman.Text = StockIn.FLinkman;
                        lblFMemo.Text = StockIn.FMemo;
                        lblFPhone.Text = StockIn.FPhone;
                        lblFDriver.Text = StockIn.FDriver;
                        lblFShipper.Text = StockIn.FShipper;
                        lblFSupercargo.Text = StockIn.FSupercargo;
                        lblFVehicleNum.Text = StockIn.FVehicleNum;
                        lblFDate.Text = Convert.ToDateTime(StockIn.FDate).ToString("yyyy-MM-dd");
                        lblCreateBy.Text = StockIn.CreateBy;
                        BindDataGrid();
                    }
                    break;
            }
