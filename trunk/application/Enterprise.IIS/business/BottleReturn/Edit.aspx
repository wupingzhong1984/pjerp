<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.BottleReturn.Edit" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        #RegionPanel1_Region1_RegionPanel2_Region3_SimpleForm1_FormRow2_ddlReturn-labelEl {
            color: red;
        }
    </style>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="空瓶回收单" Position="Center"
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="150px" EnableCollapse="True">
                                    <Items>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtCreateBy" runat="server" Label="制单人" EmptyText="制单人" LabelAlign="Right" Readonly="True">
                                                        </f:TextBox>
                                                        <f:DatePicker ID="txtFDate" runat="server" Required="false" Label="日期" LabelAlign="Right" EmptyText="日期"
                                                            ShowRedStar="false">
                                                        </f:DatePicker>
                                                ...
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="txtFPhone" runat="server" LabelAlign="Right" Label="电话" EmptyText="电话">
                                                        </f:TextBox>
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:TextBox ID="txtFLinkman" runat="server" LabelAlign="Right" Label="联系人" EmptyText="联系人">
                                                        </f:TextBox>
                                                        <f:DropDownList runat="server" ID="ddlReturn" LabelAlign="Right" Label="业务类型"
                                                            EnableEdit="False" Required="True" ShowRedStar="true" />
                                                        <f:DropDownList runat="server" ID="ddlFVehicleNum" LabelAlign="Right" Label="车牌号" EnableEdit="False" />
                                                        <f:DropDownList runat="server" ID="ddlFDriver" LabelAlign="Right" Label="送货司机" EnableEdit="True" EnableMultiSelect="true" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlFSupercargo" LabelAlign="Right" Label="押运员" EnableEdit="True" EnableMultiSelect="true" />
                                                        <f:DropDownList runat="server" ID="ddlFShipper" LabelAlign="Right" Label="发货人" EnableEdit="True" />
                                                        <f:DropDownList runat="server" ID="ddlFArea" LabelAlign="Right" Label="区域" EnableEdit="True" />
                                                ...
                                                <f:FormRow ID="FormRow4">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlDeliveryMethod" LabelAlign="Right" Label="提货方式" Required="True" ShowRedStar="True" EnableEdit="True" />
                                                        <f:TextBox ID="txtFLogisticsNumber" LabelAlign="Right" runat="server" Label="物流单号">
                                                        </f:TextBox>
                                                        <%--<f:DropDownList runat="server" LabelAlign="Right"  ID="ddlSubject" Label="银行账户"  EnableEdit="False">
                                                        </f:DropDownList>
                                                        <f:TextBox ID="txtFAmt" runat="server" LabelAlign="Right"  Label="退款金额" EmptyText="退款金额" Text="">
                                                        </f:TextBox>--%>
                                                        <f:TextBox ID="txtFMemo" LabelAlign="Right" MaxLength="200" MaxLengthMessage="最大长度限定200个字符以内" runat="server" Label="备注" EmptyText="备注">
                                                        </f:TextBox>
                                            ...
                                            <Toolbars>
                                                <f:Toolbar ID="Toolbar1" runat="server">
                                                    <Items>
                                                        ...
                                                        <f:Button ID="btnAddSupplier" runat="server" Text="新增（供货商）" Icon="Add" Size="Medium" OnClick="btnAddSupplier_Click">
                                                        </f:Button>
        ...
        <f:Window ID="Window2" runat="server" WindowPosition="Center" IsModal="true"
            ...
            IFrameUrl="about:blank" Height="450px" Width="960px" OnClose="Window1_Close">
        </f:Window>
    ...
    <script type="text/javascript">
        ...
        function LodopPrinter(keyid) {
            ...
            var strHtml = "";
            $.post("../../common/AjaxPrinter.ashx?oper=ajaxPrintBottleReturn",
				  { "keyid": keyid },
              function (result) {
                  if (result != "") {
