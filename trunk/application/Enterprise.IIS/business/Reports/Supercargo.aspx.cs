...
{
    public partial class Supercargo : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=司机押运员工作量化表{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            parms.Add("@FItemName", txtFItemName.Text.Trim());
            parms.Add("@FType", ddlFType.SelectedValue);


            var list = SqlService.ExecuteProcedureCommand("proc_FPieceWork",parms).Tables[0];
                ...
                var summary = new JObject
                    {
                        ...
                        {"FPiece2", list.Compute("sum(FPiece2)","true").ToString()},
                    };
