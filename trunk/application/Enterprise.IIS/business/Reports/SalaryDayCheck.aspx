<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalaryDayCheck.aspx.cs" Inherits="Enterprise.IIS.business.Reports.SalaryDayCheck" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" ColumnID="FFreight" DataField="FFreight" HeaderText="运输服务费" SortField="FFreight"  TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" ColumnID="FDiscountAmount" DataField="FDiscountAmount" HeaderText="优惠金额" SortField="FDiscountAmount"  TextAlign="Right" />
