...
{
    public partial class FMonthSalaryDetails : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=发货对账单{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            parms.Add("@FDistributionPoint", ddlFDistributionPoint.SelectedValue);
            //

            var list = SqlService.ExecuteProcedureCommand("rpt_FMonthSalaryDetails", parms).Tables[0];
                ...
                var summary = new JObject
                    {
                        ...
                        {"FReturnQty", list.Compute("sum(FReturnQty)","true").ToString()},
                    };
