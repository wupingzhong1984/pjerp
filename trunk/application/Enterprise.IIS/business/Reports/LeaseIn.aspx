<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LeaseIn.aspx.cs" Inherits="Enterprise.IIS.business.Reports.Lease.LeaseIn" %>
                    ...
                    <Items>
                        <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" LabelWidth="80px" EnableCollapse="False"
                            ...
                            <Items>
                                ...
                                <f:DropDownList runat="server" ID="ddlBill" Label="单据类型">
                                    <f:ListItem Text="租赁单" Value="7" Selected="true" />
                                </f:DropDownList>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnReset" runat="server" Text="重置" Icon="ArrowRefresh" OnClick="btnSearch_Click" Size="Medium">
                                </f:Button>
                                ...
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="False" Split="False"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="80px" DataField="KeyId" HeaderText="单据号" SortField="KeyId" />
                                                <f:BoundField MinWidth="80px" DataField="FDate" HeaderText="日期" SortField="FDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="220px" DataField="FName" HeaderText="客户名称" SortField="FName" />
                                                <f:BoundField MinWidth="80px" DataField="FReturnDate" HeaderText="还瓶日期" SortField="FReturnDate" DataFormatString="{0:yyyy-MM-dd}" />
                                                <f:BoundField MinWidth="80px" DataField="FAmount" HeaderText="押金" SortField="FAmount" />
                                                <f:BoundField MinWidth="80px" DataField="FPaymentRentals" HeaderText="已收租金" SortField="FPaymentRentals" />
                                                <f:BoundField MinWidth="80px" DataField="FDepositSecurity" HeaderText="退押金" SortField="FDepositSecurity" />
