...
namespace Enterprise.IIS.business.Reports
{
    ...
    ///     生成日工资结算单
    /// </summary>
    public partial class SalaryDaySettlement : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=生成日工资结算单{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            var list = SqlService.ExecuteProcedureCommand("proc_SalaryDaySettlement", parms).Tables[0];
