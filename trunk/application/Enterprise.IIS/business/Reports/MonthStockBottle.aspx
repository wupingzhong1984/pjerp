<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MonthStockBottle.aspx.cs" Inherits="Enterprise.IIS.business.Reports.MonthStockBottle" %>
                                            ...
                                            <Columns>
                                                ...
                                                <f:GroupField HeaderText="当日收入" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        ...
                                                        <f:BoundField Width="80px" ColumnID="FSalesIQty" DataField="FSalesIQty" HeaderText="销售回空" SortField="FSalesIQty" TextAlign="right" />
                                                ...
                                                <f:GroupField ColumnID="mc" HeaderText="当日支出" TextAlign="Center" EnableLock="true" SortField="mc">
                                                    <Columns>
                                                        ...
                                                        <f:BoundField Width="80px" ColumnID="FPurchaseOQty" DataField="FPurchaseOQty" HeaderText="采购出空" SortField="FPurchaseOQty" TextAlign="right" />
