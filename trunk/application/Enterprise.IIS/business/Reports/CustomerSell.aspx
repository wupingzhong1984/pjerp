<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerSell.aspx.cs" Inherits="Enterprise.IIS.business.Reports.CustomerSell" %>
...
<body>
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="客户销售排行" Position="Center"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                 ...
                                                 <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddFCode" Label="客户名称" EnableEdit="true" LabelAlign="Right" DataTextField="FName" DataValueField="FCode"></f:DropDownList>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="False" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            runat="server" EnableCheckBoxSelect="False" DataKeyNames="FName,FCode"
                                            ...
                                            <Columns>
                                                <f:LinkButtonField MinWidth="80px"  ColumnID="FCode" CommandName="actView" DataTextField="FCode" HeaderText="客户代码" SortField="FCode" TextAlign="Center" runat="server" />
                                               <%-- <f:BoundField MinWidth="80px" DataField="FCode" HeaderText="客户代码" SortField="FCode" />--%>
                                                ...
                                                <f:BoundField MinWidth="80px" ColumnID="FPrice" DataField="FPrice" HeaderText="均价" SortField="FPrice" DataFormatString="{0:f2}" TextAlign="Right" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(fcode, fconpanyid, fBDate, fEDate, fSeller) {
            var url = 'business/Reports/Finance/CustomerSellDetails.aspx?FCode=' + fcode + '&fBDate=' + fBDate + '&fEDate=' + fEDate + '&fcompanyid=' + fconpanyid + '&fSeller=' + fSeller;
