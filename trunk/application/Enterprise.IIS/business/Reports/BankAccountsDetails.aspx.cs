...
{
    public partial class BankAccountsDetails : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        private void BindDataGrid()
        {
            ...
            parms.Add("@subjectCode", FCode);

            var list = SqlService.ExecuteProcedureCommand("rpt_BankAmtDetails", parms).Tables[0];
