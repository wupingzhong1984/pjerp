<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Analyse.aspx.cs" Inherits="Enterprise.IIS.business.Reports.Analyse" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="分析计件" Position="Center"
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="32px" EnableCollapse="True">
                                    <Items>
                                                ...
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFGroup" Label="班组"
                                                            ...
                                                            ShowRedStar="True" EnableSimulateTree="true" />
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" ColumnID="FDate" DataField="FDate" HeaderText="分析日期" DataFormatString="{0:yyyy-MM-dd}" SortField="FDate" />
                                                <f:BoundField MinWidth="80px" ColumnID="FINum" DataField="FINum" HeaderText="存货代码" SortField="FINum" />
                                                <f:BoundField MinWidth="120px" DataField="FItemName" HeaderText="商品名称" SortField="FItemName" />
                                                <f:BoundField MinWidth="120px" DataField="FSpec" HeaderText="规格型号" SortField="FSpec" />
                                                <f:BoundField MinWidth="120px" DataField="FUnit" HeaderText="计量单位" SortField="FUnit" />
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FLinkman" HeaderText="分析人" SortField="FLinkman" />
