<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SendReceiver.aspx.cs" Inherits="Enterprise.IIS.business.Reports.SendReceiver" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFShipper" Label="收发" EnableEdit="True" LabelAlign="Right" Required="true" ShowRedStar="true"/>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="False" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="120px" DataField="FName" HeaderText="计件科目" SortField="FName" />
                                                <f:BoundField MinWidth="120px" DataField="FUnit" HeaderText="单位" SortField="FUnit" />
                                                <f:BoundField MinWidth="80px" ColumnID="FQty" DataField="FQty" HeaderText="计件数" SortField="FQty" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" ColumnID="FPrice" DataField="FPrice" HeaderText="单价（元）" SortField="FPrice" TextAlign="Right" />
                                                <f:BoundField MinWidth="80px" ColumnID="FAmount" DataField="FAmount" HeaderText="金额（元）" SortField="FAmount" TextAlign="Right" />
