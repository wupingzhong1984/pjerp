<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesReturnDay.aspx.cs" Inherits="Enterprise.IIS.business.Reports.SalesReturnDay" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="销售退货日报" Position="Center"
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="False" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="130px"  ColumnID="KeyId" DataField="KeyId" HeaderText="退货单号" SortField="KeyId" />
