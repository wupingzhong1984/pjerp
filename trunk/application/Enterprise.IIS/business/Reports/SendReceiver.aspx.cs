...
{
    public partial class SendReceiver : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=收发计件{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            parms.Add("@Person", ddlFShipper.SelectedValue);
            //parms.Add("@WorkShop", ddlWorkShop.SelectedValue);
            //parms.Add("@FItemCode", txtFCode.Text.Trim());

            var list = SqlService.ExecuteProcedureCommand("FSalary_Shipper", parms).Tables[0];
