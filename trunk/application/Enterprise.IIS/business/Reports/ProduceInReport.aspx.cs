...
{
    public partial class ProduceInReport :PageBase
    {
        private StockInService stockInService;

        protected StockInService StockInService
        {
            get { return stockInService ?? (stockInService = new StockInService()); }
            set { stockInService = value; }
        }
        ...
        protected void BindData()
        {
            ...
            parms.Add("@Fcode", string.IsNullOrWhiteSpace(txtFcode.Text)?"":txtFcode.Text);
            ...
            DataTable tb = SqlService.ExecuteProcedureCommand("rpt_ProductMake", parms).Tables[0];
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=产出统计表单{0}.xls", SequenceGuid.GetGuidReplace()));
