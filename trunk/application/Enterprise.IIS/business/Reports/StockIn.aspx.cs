...
namespace Enterprise.IIS.business.Reports
{
    public partial class StockIn : PageBase
    {
        ...
        protected void Grid1_RowClick(object sender, GridRowClickEventArgs e)
        {
            ...
            //var data = SqlService.ExecuteProcedureCommand("rpt_StockInDetails", parms).Tables[0];
        ...
        protected void btnExports_Click(object sender, EventArgs e)
        {
            ...
            var list = SqlService.ExecuteProcedureCommand("rpt_StockinGroup", parms).Tables[0];
            string file="";
            Utils.Export(this, list, "入库明细" + Convert.ToDateTime(dpFDateBegion.SelectedDate).ToString("yyyy-MM-dd") + "--" + Convert.ToDateTime(dpFDateEnd.SelectedDate).ToString("yyyy-MM-dd"), out file);
