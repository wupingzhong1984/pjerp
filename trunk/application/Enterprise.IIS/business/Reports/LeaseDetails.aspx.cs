...
{
    public partial class LeaseDetails : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=租赁明细表{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            //
            var list = SqlService.ExecuteProcedureCommand("rpt_FMonthLeaseDetails", parms).Tables[0];
