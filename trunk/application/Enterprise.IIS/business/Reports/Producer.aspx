<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Producer.aspx.cs" Inherits="Enterprise.IIS.business.Reports.Work.Producer" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" ColumnID="FDate" DataField="FDate" HeaderText="交货日期" DataFormatString="{0:yyyy-MM-dd}" SortField="FDate" />
