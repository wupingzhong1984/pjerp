<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FMonthAllotDetails.aspx.cs" Inherits="Enterprise.IIS.business.Reports.FMonthAllotDetails" %>
                    ...
                    <Items>
                        <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" LabelWidth="80px" EnableCollapse="False"
                            ...
                            <Items>
                                ...
                                <f:TextBox runat="server" ID="txtKeyId" Label="发货编号" />
                                ...
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="False" Split="False"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                <f:BoundField MinWidth="130px" ColumnID="FDistributionPoint" DataField="FDistributionPoint" HeaderText="调拨站点" SortField="FDistributionPoint" />
                                                <f:BoundField MinWidth="130px" ColumnID="FPoint" DataField="FPoint" HeaderText="接收站点" SortField="FPoint" />
                                                ...
                                                <f:BoundField MinWidth="220px" ColumnID="FName" DataField="FName" HeaderText="客户名称" SortField="FName" Hidden="true"/>
                                                ...
                                                <f:BoundField MinWidth="100px" ColumnID="FNum" DataField="FNum" HeaderText="销售订单" SortField="FNum" />
