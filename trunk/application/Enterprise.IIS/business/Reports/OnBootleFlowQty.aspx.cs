...
{
    public partial class OnBootleFlowQty : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=当日提瓶回瓶表{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            //if (trDept.SelectedNode != null)
            {
                ...
                var list = SqlService.ExecuteProcedureCommand("proc_OnBootleFlowQty", parms).Tables[0];
