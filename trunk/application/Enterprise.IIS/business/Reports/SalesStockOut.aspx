<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalesStockOut.aspx.cs" Inherits="Enterprise.IIS.business.Reports.Sales.SalesStockOut" %>
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" ShowHeader="false" Split="true" Hidden="True"
                    ...
                    <Items>
                        <f:SimpleForm ID="SimpleForm2" BodyPadding="5px" Width="550px" LabelWidth="100px" EnableCollapse="true"
