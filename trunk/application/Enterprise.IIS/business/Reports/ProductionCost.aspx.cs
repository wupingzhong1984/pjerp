...
{
    public partial class ProductionCost : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        private void BindDataGrid()
        {
            ...
            var list = SqlService.ExecuteProcedureCommand("proc_ProductionCost", parms).Tables[0];
                ...
                var summary = new JObject
                    {
                        ...
                        {"FMISQty", list.Compute("sum(FMISQty)","true").ToString()},
                    };
