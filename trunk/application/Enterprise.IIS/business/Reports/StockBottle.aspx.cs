...
{
    public partial class StockBottle : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                GasHelper.DropDownListDistributionPointDataBind(ddlDistributionPoint);
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=商品存货库存{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            parms.Add("@FDistributionPoint", ddlDistributionPoint.SelectedValue);

            var list = SqlService.ExecuteProcedureCommand("proc_StockBottle", parms).Tables[0];
