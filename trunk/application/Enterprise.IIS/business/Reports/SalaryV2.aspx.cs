...
{
    public partial class SalaryV2 : PageBase
    {
        /// <summary>
        ///     数据服务
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=销售分析{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            parms.Add("@FBegin", dateBegin.SelectedDate);
            parms.Add("@FEnd",dateEnd.SelectedDate);

            var list = SqlService.ExecuteProcedureCommand("rpt_SalaryV2", parms).Tables[0];
