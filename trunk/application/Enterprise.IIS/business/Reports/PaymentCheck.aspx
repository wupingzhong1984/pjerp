<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PaymentCheck.aspx.cs" Inherits="Enterprise.IIS.business.Reports.PaymentCheck" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>货款、押金核销汇总表</title>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="货款、押金核销汇总表" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FClass" HeaderText="收入/支出" SortField="FClass" />
                                                <f:BoundField MinWidth="120px" DataField="FType" HeaderText="业务类型" SortField="FType" />
                                                <f:BoundField MinWidth="120px" ColumnID="FAmount"  DataField="FAmount" HeaderText="金额" SortField="FAmount" TextAlign="Right" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
