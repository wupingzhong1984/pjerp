<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProducePlaceQty.aspx.cs" Inherits="Enterprise.IIS.business.Reports.ProducePlaceQty" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="price" HeaderText="单价" SortField="price" />
                                                <f:BoundField MinWidth="80px" DataField="FUnit" HeaderText="领用单位" SortField="FUnit"/>
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
