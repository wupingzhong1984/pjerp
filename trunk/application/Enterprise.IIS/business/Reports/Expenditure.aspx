<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Expenditure.aspx.cs" Inherits="Enterprise.IIS.business.Reports.Expenditure" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="费用支出统计" Position="Center"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:TextBox runat="server" Hidden="True" Label="客户代码" ID="txtFCode" Readonly="True" LabelAlign="Right" />
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FCode" HeaderText="报账人编码" SortField="FCode" />
                                                <f:BoundField MinWidth="220px" DataField="FName" HeaderText="报账人名称" SortField="FName" />
                                                <f:BoundField MinWidth="120px" DataField="FItemName" HeaderText="项目" SortField="FItemName" />
                                                <f:BoundField MinWidth="80px" ColumnID="FAmount" DataField="FAmount" HeaderText="销售金额" SortField="FAmount" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" ColumnID="FMemo" DataField="FMemo" HeaderText="摘要" SortField="FMemo" />
                                            </Columns>
                                            <Listeners>
