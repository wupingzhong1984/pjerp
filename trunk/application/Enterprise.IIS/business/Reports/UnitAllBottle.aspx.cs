...
{
    public partial class UnitAllBottle : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                tbxFBottle.OnClientTriggerClick = Window2.GetSaveStateReference(txtFBottleCode.ClientID,tbxFBottle.ClientID)
                    + Window2.GetShowReference("../../Common/WinBottleToInfo.aspx");
        ...
        private void BindDataGrid()
        {
            ...
            parms.Add("@end", Convert.ToDateTime(dpkFDate.SelectedDate).ToString("yyyy-MM-dd"));
            parms.Add("@FCode",txtFCode.Text);
            parms.Add("@FBottle", txtFBottleCode.Text);
            parms.Add("@companyid", ddlCompany.SelectedValue);
            parms.Add("@FName", tbxFCustomer.Text.Trim());
            parms.Add("@FBottleName", tbxFBottle.Text.Trim());
            parms.Add("@FSalesman", ddlFSalesman.SelectedValue);
