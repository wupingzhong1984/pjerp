<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomerSellDetails.aspx.cs" Inherits="Enterprise.IIS.business.Reports.CustomerSellDetails" %>
...
<body>
      <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="客户销售明细" Position="Center"
