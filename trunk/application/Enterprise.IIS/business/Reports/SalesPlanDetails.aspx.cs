...
{
    public partial class SalesPlanDetails : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=调度明细{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            var list = SqlService.ExecuteProcedureCommand("rpt_SalesPlanDetails", parms).Tables[0];
