...
{
    public partial class MonthStockGasDetails : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=气体存货流水清单{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            DataTable list = SqlService.ExecuteProcedureCommand("proc_RealtimeInventoryGas_details", parms).Tables[0];
