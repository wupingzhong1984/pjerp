<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SalaryDaySettlement.aspx.cs" Inherits="Enterprise.IIS.business.Reports.SalaryDaySettlement" %>
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="48px" EnableCollapse="True">
                                    <Items>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" ColumnID="FDate" DataField="FDate" HeaderText="日期" 
                                                    SortField="FDate" DataFormatString="{0:yyyy-MM-dd}" TextAlign="Center" />
                                                <f:BoundField MinWidth="220px" DataField="FArea" HeaderText="所属区域" SortField="FArea" />
                                                <f:BoundField MinWidth="220px" DataField="FName" HeaderText="客户名称" SortField="FName" />
                                                <f:BoundField MinWidth="80px" DataField="FBottleQty" HeaderText="实瓶数" SortField="FBottleQty" />
                                                <f:BoundField MinWidth="80px" DataField="FRecycleQty" HeaderText="空瓶数" SortField="FRecycleQty" />
                                                <f:BoundField MinWidth="120px" DataField="FDriver" HeaderText="司机" SortField="FDriver" />
                                                <f:BoundField MinWidth="120px" DataField="FVehicleNum" HeaderText="车牌号" SortField="FVehicleNum" />
