<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitAllBottle.aspx.cs" Inherits="Enterprise.IIS.business.Reports.UnitAllBottle" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="欠瓶统计分析" Position="Center"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DatePicker ID="dpkFDate" runat="server" Label="日期" DateFormatString="yyyy-MM-dd" LabelAlign="Right">
                                                        </f:DatePicker>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:TextBox runat="server" Label="钢瓶编码" ID="txtFBottleCode" LabelAlign="Right" />
                                                        <f:TriggerBox ID="tbxFBottle" Label="钢瓶名称" LabelAlign="Right" TriggerIcon="Search" runat="server" EnablePostBack="True">
                                                        </f:TriggerBox>
                                                        <f:DropDownList runat="server" ID="ddlFSalesman"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" ColumnID="FSalesman" DataField="FSalesman" HeaderText="业务员" SortField="FSalesman" />
                                                <f:BoundField MinWidth="80px" ColumnID="FBottle" DataField="FBottle" HeaderText="包装物" SortField="FBottle" />
                                                <f:BoundField MinWidth="120px" ColumnID="FBottleName" DataField="FBottleName" HeaderText="包装物" SortField="FBottleName" />
                                                <f:BoundField MinWidth="120px" ColumnID="FSpec" DataField="FSpec" HeaderText="规格" SortField="FSpec" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" ColumnID="FUnit" DataField="FUnit" HeaderText="单位" SortField="FUnit" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" ColumnID="FBottleQty" DataField="FBottleQty" HeaderText="欠瓶数" SortField="FBottleQty" TextAlign="Center" />
                                            </Columns>
                                        </f:Grid>
                                    </Items>
                                </f:Region>
        ...
        <f:Window ID="Window2" Icon="PageAttach" runat="server" Hidden="true"
            ...
            Title="钢瓶档案" CloseAction="HidePostBack"
            EnableIFrame="true" Height="450px" Width="800px">
        </f:Window>
    </form>
