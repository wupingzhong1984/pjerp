...
{
    public partial class BottleFlow : PageBase
    {
        ...
        protected void tbxFCustomer_OnTextChanged(object sender, EventArgs e)
        {
            ...
            {
                var custmoer = ViewUnitAllService.Where(p => p.FName == tbxFCustomer.Text.Trim() 
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=客户钢瓶变动表{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            //}
            var list = SqlService.ExecuteProcedureCommand("proc_BottleFlow", parms).Tables[0];
