<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParsMonthDetails.aspx.cs" Inherits="Enterprise.IIS.business.Reports.ParsMonthDetails" %>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DatePicker ID="dpFDate" runat="server" Label="年月" DateFormatString="yyyyMM">
                                                        </f:DatePicker>
