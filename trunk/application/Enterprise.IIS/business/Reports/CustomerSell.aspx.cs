...
{
    public partial class CustomerSell : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=客户销售统计{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            if (!string.IsNullOrWhiteSpace(this.ddFCode.SelectedText))
            {
                parms.Add("@FCode", this.ddFCode.SelectedValue);
            }
            var list = SqlService.ExecuteProcedureCommand("rpt_CustomerItem", parms).Tables[0];
