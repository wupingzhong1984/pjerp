<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LiquidSales.aspx.cs" Inherits="Enterprise.IIS.business.Reports.LiquidSales" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" ColumnID="FRecycleQty" DataField="FRecycleQty" HeaderText="回空数量" SortField="FRecycleQty" TextAlign="Right" Hidden="True"/>
