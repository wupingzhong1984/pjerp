...
{
    public partial class SaleNotChecked : PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=未核销销售明细表{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private void BindDataGrid()
        {
            ...
            var list = SqlService.ExecuteProcedureCommand("proc_SaleNotChecked", parms).Tables[0];
            ...
            if (list != null && list.Rows.Count > 0)
            {
                ...
                var summary = new JObject
                    {
                        {"FDate", "合计"},
                        {"FNoCheckedAmt", list.Compute("sum(FNoCheckedAmt)","true").ToString()}
                    };
