<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.VehicleRepare.Index" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="车辆维修" Position="Center"
                    ShowBorder="False" BoxConfigAlign="Stretch" Layout="Fit" runat="server" ShowHeader="False">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="车辆维修" />
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FSupercargo" HeaderText="申请人" SortField="FSupercargo" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" DataField="FShipper" HeaderText="采购人" SortField="FShipper" TextAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/VehicleRepare/Edit.aspx?KeyId=' + keyid + '&action=2';
            //var url = 'business/VehicleRepare/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【车辆维修' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/VehicleRepare/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00003', basePath + url, '添加车辆维修', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/VehicleRepare/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00003', basePath + url, '【编辑车辆维修' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
