    ...
    public partial class Edit : PageBase
    {
        ...
        private bool SubmintEdit()
        {
            if (StockIn != null)
            {
                ...
                StockIn.FClass = "车辆配件";//ddlFCate.SelectedValue;
        ...
        private bool SubmintAdd()
        {
            ...
            if (stock != null)
            {
                ...
                stock.FClass = "车辆配件";//ddlFCate.SelectedValue;
                ...
                {
                    //单据号问题
                    string newKeyId = SequenceService.CreateSequence(Convert.ToDateTime(txtFDate.SelectedDate), "VR", CurrentUser.AccountComId);
                    var orderParms = new Dictionary<string, object>();
                    orderParms.Clear();
                    orderParms.Add("@oldKeyId", txtKeyId.Text);
                    orderParms.Add("@newKeyId", newKeyId);
                    orderParms.Add("@Bill", "46");//车辆维修
                    ...
                    var billStatus = new LHBillStatus
                    {
                        ...
                        FMemo = String.Format("单据号{0},{1}新增车辆维修据。", newKeyId, CurrentUser.AccountName)
                    };
        ...
        private void InitData()
        {
            ...
            GasHelper.DropDownListShipperDataBind(ddlFSupercargo);
            ...
            switch (Actions)
            {
                case WebAction.Add:
                    ...
                    var temp = new LHStockIn
                    {
                        ...
                        //发货单
                        FType = Convert.ToInt32(GasEnumBill.VehicleRepare),
