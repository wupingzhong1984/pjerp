<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Data.aspx.cs" Inherits="Enterprise.IIS.business.SalesPlanAudit.Data" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head id="Head1" runat="server">
    <title>引入信用审核数据</title>
</head>
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" ShowBorder="False" ShowHeader="False" Title="引入信用审核数据" Position="Center"
                                    ...
                                    <Items>
                                        <f:SimpleForm ID="SimpleForm1" BodyPadding="5px" LabelWidth="135px" EnableAjax="true"
                                            ...
                                            <Items>
                                                <f:GroupPanel runat="server" Title="模版下载" ID="GPanelRoleInfo" EnableCollapse="True">
                                                    <Items>
                                                        ...
                                                        <f:ContentPanel ID="ContentPanel1" ShowBorder="false" BodyPadding="10px" ShowHeader="false"
                                                            ...
                                                            <a href="~/business/template/审核结果.xls" runat="server">下载模版</a>
                                                        </f:ContentPanel>
                                                    </Items>
                                                </f:GroupPanel>
                                                ...
                                                <f:Grid ID="Grid1" Title="引入信用审核数据" ShowBorder="false" ShowHeader="False"
                                                    ...
                                                    <Columns>
                                                        <f:BoundField Width="100px" DataField="客户编码" HeaderText="客户编码" SortField="客户编码" />
                                                        <f:BoundField Width="300px" DataField="客户名称" HeaderText="客户名称" SortField="客户名称" />
                                                        <f:BoundField Width="100px" DataField="当前余额" HeaderText="当前余额" SortField="当前余额" />
                                                        <f:BoundField Width="100px" DataField="判断" HeaderText="判断" SortField="判断" />
