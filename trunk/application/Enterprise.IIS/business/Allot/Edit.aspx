<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.AllotTrans.Edit" %>
                ...
                <f:Region ID="Region1" Title="调拨出库单" Position="Center"
                    ...
                    <Items>
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="True" Title="编辑调拨出库单" Split="False"
                                        ...
                                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow0">
                                                    <Items>
                                                        ...
                                                        <f:TriggerBox ID="tbxFLogisticsNumber" EnablePostBack="True" OnTextChanged="tbxFLogisticsNumber_OnTextChanged"
                                                            ShowLabel="true" Label="销售订单" LabelAlign="Right"
                                                ...
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlFDistributionPoint" Label="发货站点" Required="True" LabelAlign="Right" ShowRedStar="True" EnableEdit="True" />
                                                        <f:DropDownList runat="server" ID="ddlFPoint" Label="接收站点" Required="True" LabelAlign="Right" ShowRedStar="True" EnableEdit="True" />
                                                        <f:DropDownList runat="server" ID="ddlFSendee" Label="收货人" EnableEdit="True" LabelAlign="Right" />
