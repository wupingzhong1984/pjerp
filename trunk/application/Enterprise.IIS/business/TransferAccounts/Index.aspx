<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.TransferAccounts.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="银行存取单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="银行存取单"/>
                                <f:ToolbarSeparator ID="ToolbarSeparator2" runat="server" />
                                <f:Button ID="btnSearch" OnClick="btnSearch_Click" runat="server" Text="查询" Icon="Zoom" Hidden="False" Size="Medium">
                                </f:Button>
                                <f:Button ID="btnAdd" runat="server" OnClientClick="openAddUI();" Text="存取" Icon="Coins" Hidden="True" Size="Medium">
                                </f:Button>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FFKName" HeaderText="付款账户" SortField="FFKName" />
                                                <f:BoundField MinWidth="80px" DataField="FSKName" HeaderText="收款账户" SortField="FSKName" />
                                                <f:BoundField MinWidth="220px" DataField="FAccount" HeaderText="金额" SortField="FAccount" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/TransferAccounts/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【银行存取单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/TransferAccounts/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加银行存取单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/TransferAccounts/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑银行存取单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
