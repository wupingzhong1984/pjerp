<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PreIndex.aspx.cs" Inherits="Enterprise.IIS.business.SalesPlan.PreIndex" %>
...
<body>
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnFormal" OnClick="btnFormal_Click" runat="server"  Text="转正式订单"
    ...
    <script type="text/javascript">
        ...
        function openAddUI() {
            var url = 'business/SalesPlan/PreEdit.aspx?action=1';
        ...
        function openEditUI(keyid) {
            var url = 'business/SalesPlan/PreEdit.aspx?KeyId=' + keyid + '&action=2';
