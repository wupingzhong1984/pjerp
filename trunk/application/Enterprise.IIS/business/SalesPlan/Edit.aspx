<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.SalesPlan.Edit" %>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow6">
                                                    <Items>
                                                        ...
                                                        <f:TextBox ID="pubNum" runat="server" Label="下单数量" EmptyText="1" LabelAlign="Right" Text="1" />
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
