<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.SalesPlan.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="销售订单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="销售订单" />
                                        ...
                                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlStatus" Label="单据状态" LabelAlign="Right">
                                                            <f:ListItem Text="已制单" Value="10" Selected="true" />
                                                            <f:ListItem Text="已配送" Value="50" />
                                                            <f:ListItem Text="已作废" Value="0" />
                                                            <f:ListItem Text="已完成" Value="100" />
                                                        </f:DropDownList>
                                                        <f:CheckBox runat="server" ID="chkall" Label="所有未配送订单" Checked="false" LabelWidth="110%" AutoPostBack="true" OnCheckedChanged="chkall_CheckedChanged"></f:CheckBox>
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:TemplateField Width="100px" HeaderText="审核状态" TextAlign="Left">
                                                    <ItemTemplate>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/SalesPlan/Edit.aspx?KeyId=' + keyid + '&action=2';
            //var url = 'business/PassCard/Edit.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【销售订单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/SalesPlan/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加销售订单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/SalesPlan/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑销售订单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
