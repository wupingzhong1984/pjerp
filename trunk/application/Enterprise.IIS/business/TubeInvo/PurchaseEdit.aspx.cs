    ...
    public partial class PurchaseEdit : PageBase
    {
        ...
        private bool SubmintAdd()
        {
            ...
            if (stock != null)
            {
                ...
                if (txtKeyId.Text.Contains("TM"))
                {
                    ...
                    orderParms.Add("@Bill", Convert.ToInt32(GasEnumBill.TubePurchase));
        ...
        private void InitData()
        {
            ...
            tbxFLogisticsNumber.OnClientTriggerClick = Window2.GetSaveStateReference(tbxFLogisticsNumber.ClientID)
                    + Window2.GetShowReference("../../Common/WinPassCardList.aspx?FType=2");
            ...
            switch (Actions)
            {
                case WebAction.Add:
                    ...
                    var temp = new LHStockIn
                    {
                        ...
                        //发货单
                        FType = Convert.ToInt32(GasEnumBill.TubePurchase),
