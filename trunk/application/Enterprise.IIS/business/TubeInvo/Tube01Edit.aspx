<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tube01Edit.aspx.cs" Inherits="Enterprise.IIS.business.TubeInvo.Tube01Edit" %>
                                        ...
                                        <f:Grid ID="Grid1" PageSize="20"
                                            ...
                                            <Toolbars>
                                                <f:Toolbar ID="Toolbar1" runat="server">
                                                    <Items>
                                                        <f:Button ID="btnAddProduct" runat="server" Text="新增" OnClick="btnAddProduct_OnClick" Icon="CartAdd" Size="Medium">
                                                        </f:Button>
