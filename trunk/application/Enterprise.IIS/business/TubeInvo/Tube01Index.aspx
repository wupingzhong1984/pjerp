<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Tube01Index.aspx.cs" Inherits="Enterprise.IIS.business.TubeInvo.Tube01Index" %>
...
<body>
                        ...
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="false" Split="False"
                                    ...
                                    BodyPadding="3px" runat="server" Height="65px" EnableCollapse="True">
                                    <Items>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/TubeInvo/Tube01Edit.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【氢气销售' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/TubeInvo/Tube01Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加氢气销售', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/TubeInvo/Tube01Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑氢气销售' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
