<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PurchaseIndex.aspx.cs" Inherits="Enterprise.IIS.business.TubeInvo.PurchaseIndex" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="氢气采购" Position="Center"
                    ShowBorder="False" BoxConfigAlign="Stretch" Layout="Fit" runat="server" ShowHeader="False">
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="氢气采购" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            ...
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【氢气采购' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Purchase/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00003', basePath + url, '添加氢气采购', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Purchase/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00003', basePath + url, '【编辑氢气采购' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
