<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.AllotPlan.Edit" %>
...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        #RegionPanel1_Region1_RegionPanel2_Region3_SimpleForm1_FormRow4_ddlFPoint-labelEl {
            color: red;
        }
...
<body>
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                <f:Region ID="Region1" Title="调拨申请单" Position="Center"
                    ShowBorder="false" BoxConfigAlign="Stretch" Layout="Fit" runat="server" ShowHeader="False">
                    <Items>
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="True" Title="编辑调拨申请单" Split="False"
                                    Position="Top" Layout="Fit"
                                    BodyPadding="3px" runat="server" Height="212px" EnableCollapse="False">
                                    <Items>
                                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        <f:TextBox runat="server" Label="客户代码" ID="txtFCode" Required="True" LabelAlign="Right" Text="PU" />
                                                        <f:TriggerBox ID="tbxFCustomer" EnablePostBack="True" OnTextChanged="tbxFCustomer_OnTextChanged"
                                                            ...
                                                            Readonly="false" TriggerIcon="Search" runat="server"  AutoPostBack="True" Text="上海浦江特种气体有限公司">
                                                        </f:TriggerBox>
                                                ...
                                                <f:FormRow ID="FormRow4">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlFDistributionPoint" Label="调拨站点" Required="True" LabelAlign="Right" ShowRedStar="True" EnableEdit="True" />
                                                        <f:DropDownList runat="server" ID="ddlFPoint" Label="接收站点" Required="True" LabelAlign="Right" ShowRedStar="True" EnableEdit="True" />
                                                ...
                                                <f:FormRow ID="FormRow6">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFAddress" Label="地址" EnableEdit="False" LabelAlign="Right">
                                                        </f:DropDownList>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" 
                                            ...
                                            <Columns>
                                                ...
                                                <f:RenderField MinWidth="60px" ColumnID="FPrice" Hidden="true" DataField="FPrice" FieldType="Double" TextAlign="Right"
                                                    HeaderText="单价">
                                                    <Editor>
                                                        <f:NumberBox ID="tbxFPrice" Required="true" runat="server" DecimalPrecision="3" Hidden="true">
                                                        </f:NumberBox>
                                                    </Editor>
                                                </f:RenderField>
