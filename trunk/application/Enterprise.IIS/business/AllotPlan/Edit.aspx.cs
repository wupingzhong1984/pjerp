    ...
    public partial class Edit : PageBase
    {
        ...
        private bool SubmintEdit()
        {
            if (StockOut != null)
            {
                ...
                //------------------------------------------------------
                StockOut.FAddress = ddlFAddress.SelectedText;//txtFAddress.Text.Trim();
                ...
                StockOut.FAddress = ddlFAddress.SelectedValue;
        ...
        private bool SubmintAdd()
        {
            ...
            if (stock != null)
            {
                ...
                stock.FAddress = ddlFAddress.SelectedValue;
                ...
                {
                    //单据号问题
                    string newKeyId = SequenceService.CreateSequence(Convert.ToDateTime(txtFDate.SelectedDate), "AT", CurrentUser.AccountComId);
                    var orderParms = new Dictionary<string, object>();
                    orderParms.Clear();
                    orderParms.Add("@oldKeyId", txtKeyId.Text);
                    orderParms.Add("@newKeyId", newKeyId);
                    orderParms.Add("@Bill", "53");
            ...
            switch (Actions)
            {
                case WebAction.Add:
                    ...
                    var temp = new LHPassCard
                    {
                        ...
                        //AllotPlan
                        FType = Convert.ToInt32(GasEnumBill.AllotPlan),
