...
namespace Enterprise.IIS.business.VehicleFuel
{
    public partial class Edit : PageBase
    {
        ...
        private bool SubmintEdit()
        {
            if (StockOut != null)
            {
                ...
                StockOut.FAmt = Convert.ToDecimal(txtFAmt.Text);

                StockOut.FBarcode = txtFBarcode.Text.Trim();
                StockOut.FUpdateDate = dataFUpdateDate.SelectedDate;
                ...
                //StockOut.FAmt = Convert.ToDecimal(txtFAmt.Text.Trim());
                ...
                //StockOut.FCate = ddlFCate.SelectedValue;
                StockOut.FDate = txtFDate.SelectedDate;
                ...
                //orders.Add("@KeyId", StockOut.KeyId);
        ...
        private bool SubmintAdd()
        {
            ...
            if (stock != null)
            {
                ...
                stock.FBarcode =txtFBarcode.Text.Trim();
                stock.FUpdateDate= dataFUpdateDate.SelectedDate;
                ...
                stock.FShipper = GasHelper.GetDropDownListArrayString(ddlFShipper.SelectedItemArray);
                ...
                {
                    //单据号问题
                    string newKeyId = SequenceService.CreateSequence(Convert.ToDateTime(txtFDate.SelectedDate), "VF", CurrentUser.AccountComId);
                    var orderParms = new Dictionary<string, object>();
                    orderParms.Clear();
                    orderParms.Add("@oldKeyId", txtKeyId.Text);
                    orderParms.Add("@newKeyId", newKeyId);
                    orderParms.Add("@Bill", "47");
                    ...
                    var billStatus = new LHBillStatus
                    {
                        ...
                        FMemo = String.Format("单据号{0},柴油加油新增单据。", newKeyId, CurrentUser.AccountName)
                    };
            ...
            switch (Actions)
            {
                case WebAction.Add:
                    ...
                    var temp = new LHStockOut
                    {
                        ...
                        //发货单
                        FType = Convert.ToInt32(GasEnumBill.VehicleFuel),
                ...
                case WebAction.Edit:
                    ...
                    if (StockOut != null)
                    {
                        ...
                        txtFAmt.Text=StockOut.FAmt.ToString();

                        txtFBarcode.Text=StockOut.FBarcode;
                        dataFUpdateDate.SelectedDate=StockOut.FUpdateDate ;
