<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.VehicleFuel.Index" %>
...
<body>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            AllowSorting="False" EmptyText="查询无结果" EnableHeaderMenu="True" EnableSummary="true" SummaryPosition="Flow">
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FDate" HeaderText="加油日期" SortField="FDate" DataFormatString="{0:yyyy-MM-dd}" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" ColumnID="FVehicleNum" DataField="FVehicleNum" HeaderText="车牌号" SortField="FVehicleNum" />
                                                <f:BoundField MinWidth="80px" DataField="CreateBy" HeaderText="操作员" SortField="CreateBy" TextAlign="Center" />
                                                
                                                <f:BoundField MinWidth="120px"  ColumnID="FAmount" DataField="FAmount" HeaderText="加油数量（L）" SortField="FAmount" />
                                                <f:BoundField MinWidth="120px" DataField="FAmt" HeaderText="加油公里数" SortField="FAmt" />
                                                
                                                <f:BoundField MinWidth="120px" DataField="FDriver" HeaderText="司机签字" SortField="FDriver" />
                                                <f:BoundField MinWidth="120px" DataField="FShipper" HeaderText="仓库签字" SortField="FShipper" />
                                                
                                                <f:BoundField MinWidth="120px" DataField="FBarcode" HeaderText="开锁签字" SortField="FBarcode" />
                                                <f:BoundField MinWidth="120px" DataField="FShipper" HeaderText="长途开锁日期及签字" SortField="FShipper" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/VehicleFuel/Edit.aspx?KeyId=' + keyid + '&action=2';
            //var url = 'business/VehicleFuel/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【加油登记' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/VehicleFuel/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加加油登记', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/VehicleFuel/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑加油登记' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
