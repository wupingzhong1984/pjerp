    ...
    public partial class Index : PageBase
    {
        ...
        protected void btnData_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    Alert.Show(inInterface.SubmitPurchase(sid, CurrentUser.AccountComId), "消息提示", MessageBoxIcon.Information);
        ...
        protected void Grid1_RowDataBound(object sender, GridRowEventArgs e)
        {
            ...
            if (item != null)
            {
                ...
                else e.Values[15] = string.Join(",", fmeno.ToList());
            }
        }
        ...
        protected void btnCopy_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string keyId = SqlService.ExecuteProcedureCommand("proc_CopySalesReturn", parms).Tables[0].Rows[0][0].ToString();
        ...
        protected void btnEdit_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    string status = Grid1.DataKeys[Grid1.SelectedRowIndexArray[0]][2].ToString();
                    if (status.Equals("已同步"))
                    {
                        Alert.Show("已同步单据不可更改！", MessageBoxIcon.Information);
                    }
                    else
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=采购单{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private Expression<Func<LHStockIn, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            ...
            // 单据类型
            int ftype = Convert.ToInt32(GasEnumBill.Purchase);
            expr = Expression.And(expr,
