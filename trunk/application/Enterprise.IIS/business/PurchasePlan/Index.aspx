<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.PurchasePlan.Index" %>
...
<body>
    <form id="form1" runat="server">
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                ...
                                <f:Button ID="btnAuditDetails" OnClick="btnAuditDetails_Click" runat="server" Text="审核流程详细"
                                    Icon="ApplicationViewDetail" Hidden="False" Size="Medium">
                                </f:Button>

                                <%--<f:Button ID="btnPrint" runat="server" Text="打印采购申请单" OnClick="btnPrint_Click"
                                    Icon="Printer" Hidden="True" Size="Medium">
                                </f:Button>
                                
                                <f:Button ID="btnSendPrint" runat="server" Text="打印签收单" OnClick="btnSendPrint_Click"
                                    Icon="Printer" Hidden="True" Size="Medium">
                                </f:Button>--%>
        ...
        <f:Window ID="Window2" Icon="PageAttach" runat="server" Hidden="true"
            ...
            EnableIFrame="true" Height="450px" Width="420px">
        </f:Window>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/PurchasePlan/Edit.aspx?KeyId=' + keyid + '&action=2';
            //var url = 'business/PassCard/Edit.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【采购采购订单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/PurchasePlan/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加采购订单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/PurchasePlan/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑采购订单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
