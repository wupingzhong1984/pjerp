<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Audit.aspx.cs" Inherits="Enterprise.IIS.business.PurchasePlan.Audit" %>
                ...
                <f:Region ID="Region1" Title="采购申请单" Position="Center"
                    ...
                    <Items>
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="True" Title="编辑采购申请单" Split="False"
                                    Position="Top" Layout="Fit"
                                    BodyPadding="3px" runat="server" Height="190px" EnableCollapse="False">
                                    <Items>
                                        <f:Form ID="SimpleForm1" ShowBorder="false" ShowHeader="False" LabelWidth="80px"
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow5" Hidden="True">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlFCate" 
                                                            Label="业务类型" Required="True" ShowRedStar="True">
                                                            <f:ListItem Text="气体采购" Value="气体采购" Selected="true" />
                                        ...
                                        <f:Grid ID="Grid1" PageSize="20" 
                                            ...
                                            <Toolbars>
                                                <f:Toolbar ID="Toolbar1" runat="server">
                                                    <Items>
                                                        ...
                                                        <f:Button ID="btnSubmit" Text="审核" runat="server" Icon="PageAttach"
                                                            OnClick="btnSubmit_Click" Size="Medium">
                                                        </f:Button>
                                                        
                                                        <f:Button ID="btnBillFlow" Text="审批过程详情" runat="server"
                                                             Icon="PageFind" 
                                                            OnClick="btnBillFlow_Click" Size="Medium">
                                                        </f:Button>
                                            ...
                                            <Columns>
                                                <f:LinkButtonField TextAlign="Center" ConfirmText="删除选中行？" Icon="Delete" HeaderText="删除" ConfirmTarget="Top"
                                                    ColumnID="colDelete"  Width="55px" CommandName="Delete" Hidden="True" SortField="mc">
                                                </f:LinkButtonField>
