<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.BottleDetection.Index" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            ...
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【钢瓶检测' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Sales/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加钢瓶检测', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Sales/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑钢瓶检测' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
