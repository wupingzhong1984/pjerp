<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.TubeSales.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="发货单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="发货单"/>
                                ...
                                <f:Button ID="btnTubeSales" OnClick="btnTubeSales_Click" runat="server" Text="转发货单"
                                    Icon="CartGo" Hidden="false" Size="Medium">
                                </f:Button>
                                ...
                                <f:Button ID="btnPrintSwap" runat="server" Text="打印换货单" OnClick="btnPrintSwap_Click"
                                    Icon="Printer" Hidden="True" Size="Medium">
                                </f:Button>
                                
                                <f:Button ID="btnPrintBlank" runat="server" Text="打印空白单" OnClick="btnPrintBlank_Click"
                                    Icon="Printer" Hidden="True" Size="Medium">
                                </f:Button>
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            OnRowDataBound="Grid1_RowDataBound" SummaryPosition="Flow" EnableSummary="True">
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" ColumnID="FAmount" DataField="FAmount" HeaderText="货款" SortField="FAmount" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FAmt" HeaderText="实收款" SortField="FAmt" TextAlign="Right" />
                                                <f:BoundField MinWidth="120px" DataField="FSubjectName" HeaderText="收款账户" SortField="FSubjectName" TextAlign="Left" />
                                                ...
                                                <%--<f:BoundField MinWidth="80px" DataField="FT6BillStatus" HeaderText="T6开票状态" SortField="FT6BillStatus" TextAlign="Center" />
                                                <f:BoundField MinWidth="80px" DataField="FT6PaymentStatus" HeaderText="T6收款状态" SortField="FT6PaymentStatus" TextAlign="Center" />
                                                --%>
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/TubeSales/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【发货单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/TubeSales/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加发货单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/TubeSales/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑发货单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
        ...
        function LodopPrinter(keyid) {
            ...
            var strHtml = "";
            $.post("../../common/AjaxPrinter.ashx?oper=ajaxPrintTubeSales",
				  { "keyid": keyid },
              function (result) {
                  if (result != "") {
