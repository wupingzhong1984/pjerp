<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.TubeSales.Edit" %>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="130px" DataField="FINum" HeaderText="存货代码" SortField="FINum" />
                                                <f:BoundField MinWidth="130px" DataField="FItemName" HeaderText="存货名称" SortField="FItemName" />
