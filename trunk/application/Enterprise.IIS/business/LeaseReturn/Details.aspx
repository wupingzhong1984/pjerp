<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.LeaseReturn.Details" %>
    ...
    <form id="form1" runat="server">
        ...
        <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
            <Regions>
                ...
                <f:Region ID="Region1" Title="气瓶租金收款单" Position="Center"
                                ...
                                <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                    ...
                                    <Items>
                                        <f:TabStrip ID="TabStrip1" AutoPostBack="true" ShowBorder="false" ActiveTabIndex="0" runat="server">
                                            <Tabs>
                                                <f:Tab Title="回收明细" BodyPadding="0px"
                                                    ...
                                                    <Items>
                                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <f:BoundField MinWidth="80px" DataField="FDays" HeaderText="天数" SortField="FDays" TextAlign="Right" />
                                                                <f:BoundField MinWidth="80px" DataField="FPaymentRentals" HeaderText="应收租金" SortField="FPaymentRentals" TextAlign="Right" />
                                                                <f:BoundField MinWidth="80px" DataField="FDepositSecurity" HeaderText="退押金" SortField="FDepositSecurity" TextAlign="Right" />
                                                            </Columns>
                                                        </f:Grid>
                                                    </Items>
                                                </f:Tab>
                                                    ...
                                                    <Items>
                                                        <f:Grid ID="Grid4" PageSize="20" ShowBorder="False" ShowHeader="False" AllowPaging="False"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <f:BoundField MinWidth="60px" DataField="FPrice" HeaderText="押金/瓶" SortField="FPrice" />
                                                                <f:BoundField MinWidth="80px" DataField="FBottleQty" HeaderText="数量" SortField="FBottleQty" />
                                                                <f:BoundField MinWidth="80px" DataField="FRentDay" TextAlign="Right" HeaderText="租金/天" />
                                                                <f:BoundField MinWidth="80px" DataField="FPaymentRentals" HeaderText="应收租金" SortField="FPaymentRentals" TextAlign="Right" />
                                                                <f:BoundField MinWidth="80px" DataField="FDepositSecurity" HeaderText="退押金" SortField="FDepositSecurity" TextAlign="Right" />
                                                            </Columns>
                                                        </f:Grid>
