...
namespace Enterprise.IIS.business.LeaseReturn
{
    public partial class Details : PageBase
    {
        ...
        ///     
        /// </summary>
        private LHLeaseReturn _leaseReturn;
        ...
        {
            get { return _leaseReturn ?? (_leaseReturn = LeaseReturnService.FirstOrDefault(p => p.KeyId == KeyId&&p.FCompanyId==CurrentUser.AccountComId)); }
            set { _leaseReturn = value; }
        }
        ...
        private void LoadData()
        {
            switch (Actions)
            {
                case WebAction.Details:
                    ...
                    if (LeaseReturn != null)
                    {
                        lblCustomer.Text = LeaseReturn.FName;
                        lblFAddress.Text = LeaseReturn.FAddress;
                        //lblFFreight.Text = LeaseReturn.FFreight.ToString();
                        lblFLinkman.Text = LeaseReturn.FLinkman;
                        lblFMemo.Text = LeaseReturn.FMemo;
                        lblFPhone.Text = LeaseReturn.FPhone;
                        lblFDriver.Text = LeaseReturn.FDriver;
                        lblFShipper.Text = LeaseReturn.FShipper;
                        lblFSupercargo.Text = LeaseReturn.FSupercargo;
                        lblFVehicleNum.Text = LeaseReturn.FVehicleNum;
                        lblFDate.Text = Convert.ToDateTime(LeaseReturn.FDate).ToString("yyyy-MM-dd");
