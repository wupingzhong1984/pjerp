<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Enterprise.IIS.business.Analyse.Edit" %>
                ...
                <f:Region ID="Region1" Title="气体分析" Position="Center"
                    ...
                    <Items>
                        <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                            <Regions>
                                <f:Region ID="Region3" ShowBorder="false" ShowHeader="True" Title="编辑气体分析" Split="False"
                                    Position="Top" Layout="Fit"
                                    BodyPadding="3px" runat="server" Height="130px" EnableCollapse="False">
                                    <Items>
                                            ...
                                            <Rows>
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" Hidden="True" ID="ddlFCate" Label="出仓类型" EnableEdit="True" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        <f:DropDownList runat="server" ID="ddlOrgnization" Label="分析部门" />
                                                        <f:TextBox ID="txtFLinkman" MaxLength="20" runat="server" Label="分析人" EmptyText="分析人">
                                                        </f:TextBox>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlT6ReceiveSendType" Label="收发类型" Hidden="True"
                                                ...
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        ...
                                                        <f:DropDownList runat="server" ID="ddlFSalesman" Label="业务员" LabelAlign="Right" Hidden="True" />
                                                    </Items>
                                                </f:FormRow>
                                            </Rows>
                                        </f:Form>
