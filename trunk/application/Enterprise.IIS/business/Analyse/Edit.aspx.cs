    ...
    public partial class Edit : PageBase
    {
        ...
        private bool SubmintEdit()
        {
            if (StockOut != null)
            {
                ...
                StockOut.FCode = ddlOrgnization.SelectedValue;
                StockOut.FName = ddlOrgnization.SelectedText.Trim();
                //------------------------------------------------------
                ...
                StockOut.FT6Warehouse = ddlFWarehouse.SelectedValue;
                ...
                StockOut.FGroup = ddlFGroup.SelectedValue;
        ...
        private bool SubmintAdd()
        {
            ...
            if (stock != null)
            {
                ...
                {
                    //单据号问题
                    string newKeyId = SequenceService.CreateSequence(Convert.ToDateTime(txtFDate.SelectedDate), "AN", CurrentUser.AccountComId);
                    var orderParms = new Dictionary<string, object>();
                    orderParms.Clear();
                    orderParms.Add("@oldKeyId", txtKeyId.Text);
                    orderParms.Add("@newKeyId", newKeyId);
                    orderParms.Add("@Bill", "54");
            ...
            switch (Actions)
            {
                case WebAction.Add:
                    ...
                    var temp = new LHStockOut
                    {
                        ...
                        //发货单
                        FType = Convert.ToInt32(GasEnumBill.Analyse),
                ...
                case WebAction.Edit:
                    ...
                    if (StockOut != null)
                    {
                        ...
                        ddlFSalesman.SelectedValue = StockOut.FSalesman;
