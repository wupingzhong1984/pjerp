<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.Dispatch.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="车辆调度日志" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items>
                                <f:Label runat="server" ID="headerText" Text="车辆调度日志"/>
                                ...
                                <f:Button ID="btnData" OnClick="btnData_Click" runat="server" Hidden="True" Text="上传"
                                    Icon="DatabaseRefresh" Size="Medium" EnableAjax="false" DisableControlBeforePostBack="false" >
                                </f:Button>
                                ...
                                <f:Button ID="btnXml" OnClick="btnXml_Click" runat="server" Text="引出行车路单"
                                    Icon="Note" Size="Medium" EnableAjax="false" DisableControlBeforePostBack="false" >
                                </f:Button>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FLogisticsName" HeaderText="物流公司" SortField="FLogisticsName" />
                                                ...
                                                <f:BoundField MinWidth="120px" DataField="FDispatcher" HeaderText="调度员" SortField="FDispatcher" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            var url = 'business/Dispatch/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【车辆调度日志' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Dispatch/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '添加车辆调度日志', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Dispatch/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑车辆调度日志' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
        ...
        function LodopPrinter(keyid) {
            ...
            var strHtml = "";
            $.post("../../common/AjaxPrinter.ashx?oper=ajaxPrintLogDoc",
				  { "keyid": keyid },
              function (result) {
                  if (result != "") {
