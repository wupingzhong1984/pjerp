...
namespace Enterprise.IIS.business.FinanceGeneralExpense
{
    public partial class Index : PageBase
    {
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=一般费用单{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        private Expression<Func<LHFKOrder, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            ...
            int ftype = Convert.ToInt32(GasEnumBill.GeneralExpense);
