<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.FinanceGeneralExpense.Index" %>
...
<body>
                ...
                <f:Region ID="Region1" Title="一般费用单" Position="Center"
                    ...
                    <Toolbars>
                        <f:Toolbar ID="Toolbar1" runat="server">
                            <Items> 
                                <f:Label runat="server" ID="headerText" Text="一般费用单"/>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="20" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FDate" HeaderText="采购日期" SortField="FDate" DataFormatString="{0:yyyy-MM-dd}" TextAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            ...
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '【一般费用单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/FinanceInternalExpense/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '添加一般费用单', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/FinanceInternalExpense/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_' + timestamp, basePath + url, '【编辑一般费用单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
