<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Index.aspx.cs" Inherits="Enterprise.IIS.business.Production.Index" %>
...
<body>
                                    ...
                                    <Items>
                                        <f:Grid ID="Grid1" PageSize="200" ShowBorder="false" ShowHeader="false" AllowPaging="true"
                                            ...
                                            <Columns>
                                                ...
                                                <f:BoundField MinWidth="80px" DataField="FDate" HeaderText="生产日期" SortField="FDate" DataFormatString="{0:yyyy-MM-dd}" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" DataField="FVehicleNum" HeaderText="生产员" SortField="FVehicleNum" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" DataField="FBatchNumber" HeaderText="批次号" SortField="FBatchNumber" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" DataField="FProductionWorkshop" HeaderText="生产车间" SortField="FProductionWorkshop" TextAlign="Center" />
                                                <f:BoundField MinWidth="120px" DataField="FDriver" HeaderText="检测员" SortField="FDriver" TextAlign="Center" />
    ...
    <script type="text/javascript">
        ...
        function openDetailsUI(keyid) {
            ...
            var url = 'business/Production/Edit.aspx?KeyId=' + keyid + '&action=2';
            //var url = 'business/Production/Details.aspx?action=6&keyid=' + keyid;
            parent.addExampleTab.apply(null, ['add_tab_' + keyid, basePath + url, '【生产单' + keyid + '详情】', basePath + 'icon/page_find.png', true]);
        };
        function openAddUI() {
            var url = 'business/Production/Edit.aspx?action=1';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【添加生产单】', basePath + 'icon/page_add.png', true]);
        };
        function openEditUI(keyid) {
            var url = 'business/Production/Edit.aspx?KeyId=' + keyid + '&action=2';
            parent.addExampleTab.apply(null, ['add_tab_00001', basePath + url, '【编辑生产单' + keyid + '】', basePath + 'icon/page_edit.png', true]);
        };
