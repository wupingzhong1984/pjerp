...
namespace Enterprise.IIS.business.Production
{
    public partial class Details : PageBase
    {
        ...
        {
            get { return _supplier ?? (_supplier = SupplierService.FirstOrDefault(p => p.FCode == txtKeyId.Text.Trim() && p.FCompanyId == CurrentUser.AccountComId)); }
            set { _supplier = value; }
        }
        ...
        private void BindDataGrid()
        {
            ...
            var source = SqlService.ExecuteProcedureCommand("proc_ProductionMaterial",parms);
            ...
            switch (Actions)
            {
                case WebAction.Details:
                    ...
                    if (StockIn != null)
                    {
                        ...
                        ddlFProducer.Text = StockIn.FProducer;
                        ddlFSurveyor.Text = StockIn.FSurveyor;
