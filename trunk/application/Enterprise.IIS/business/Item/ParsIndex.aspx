<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ParsIndex.aspx.cs" Inherits="Enterprise.IIS.business.Item.ParsIndex" %>
...
<body>
                ...
                <f:Region ID="Region1" ShowHeader="false" Split="true"  ShowBorder="False"
                    ...
                    <Items>
                        <f:Tree ID="trDept" Width="50px" OnNodeCommand="trDept_NodeCommand" ShowHeader="False"
                            ShowBorder="false" Icon="House" Title="附件分类" runat="server" EnableTextSelection="true"
                            EnableArrows="true" AutoScroll="True">
                        </f:Tree>
                    </Items>
                </f:Region>
                <f:Region ID="Region2" Title="配件档案" Position="Center"
    ...
    <script type="text/javascript">
        ...
        function openAddFineUI(url) {
            parent.addExampleTab.apply(null, ['add_fineui_pars', basePath + url, '引入配件档案', basePath + 'icon/database_add.png', true]);
        }
