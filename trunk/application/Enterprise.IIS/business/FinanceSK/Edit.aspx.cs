...
namespace Enterprise.IIS.business.FinanceSK
{
    public partial class Edit : PageBase
    {
        ...
        ///     数据服务
        /// </summary>
        private SKOrderBanksService _skOrderBanksService;

        /// <summary>
        ///     数据服务
        /// </summary>
        protected SKOrderBanksService SKOrderBanksService
        {
            get { return _skOrderBanksService ?? (_skOrderBanksService = new SKOrderBanksService()); }
        ...
        protected void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            ////var data = SqlService.ExecuteProcedureCommand("proc_CustomerARDetails", parms);
            ...
            if (tblAmt != null && tblAmt.Rows.Count > 0)
            {
                ...
                lblDisAmount.Text = tblAmt.Rows[0]["FDisAMount"].ToString();
            }
        }
        ...
        protected void Grid1_RowCommand(object sender, GridCommandEventArgs e)
        {
            if (e.CommandName == "Delete" || e.CommandName == "Add")
            {
                ...
                SKOrderBanksService.Delete(p => p.FId == datakey&&p.FCompanyId==CurrentUser.AccountComId);
