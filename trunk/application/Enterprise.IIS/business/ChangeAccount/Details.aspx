<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Details.aspx.cs" Inherits="Enterprise.IIS.business.ChangeAccount.Details" %>
                                            ...
                                            <Rows>
                                                ...
                                                <f:FormRow ID="FormRow1">
                                                    <Items>
                                                        ...
                                                        <f:Label ID="tbxFCustomer" Label="客户名称" runat="server">
                                                        </f:Label>
                                                        <f:Label ID="txtFAddress" Label="客户地址" runat="server">
                                                        </f:Label>
                                                ...
                                                <f:FormRow ID="FormRow2">
                                                    <Items>
                                                        ...
                                                        <f:Label runat="server" ID="ddlFVehicleNum" Label="车牌号" />
                                                        <f:Label runat="server" ID="ddlFDriver" Label="送货司机" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow3">
                                                    <Items>
                                                        <f:Label runat="server" ID="ddlFSupercargo" Label="押运员" />
                                                        <f:Label runat="server" ID="ddlFShipper" Label="发货人" />
                                                        <f:Label runat="server" ID="ddlFArea" Label="区域" />
                                                        <f:Label runat="server" ID="ddlFSalesman" Label="业务员" />
                                                    </Items>
                                                </f:FormRow>
                                                <f:FormRow ID="FormRow4">
                                                    <Items>
                                                        ...
                                                        <f:Label ID="txtFAmount" runat="server" Label="应收金额">
                                                        </f:Label>
                                                        <f:Label ID="txtFAmt" runat="server" Label="实收金额">
                                                        </f:Label>
                                                    </Items>
                                                </f:FormRow>
