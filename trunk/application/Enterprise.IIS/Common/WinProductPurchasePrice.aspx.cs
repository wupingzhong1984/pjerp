...
{
    public partial class WinProductPurchasePrice :  PageBase
    {
        /// <summary>
        ///     排序字段
        /// </summary>
        ...
        ///     数据服务
        /// </summary>
        private ItemPurchaseService _itemsService;
        ...
        ///     数据服务
        /// </summary>
        protected ItemPurchaseService ItemsService
        {
            get { return _itemsService ?? (_itemsService = new ItemPurchaseService()); }
        ...
        private void BindDataGrid()
        {
            ...
            Expression<Func<vm_ItemsPurchasePrice, bool>> predicate = BuildPredicate(out orderingSelector);

            //取数据源
            IQueryable<vm_ItemsPurchasePrice> list = ItemsService.Where(predicate, Grid1.PageSize, Grid1.PageIndex + 1,
        ...
        /// <returns></returns>
        private Expression<Func<vm_ItemsPurchasePrice, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            // 查询条件表达式
            Expression expr = Expression.Constant(true);

            ParameterExpression parameter = Expression.Parameter(typeof(vm_ItemsPurchasePrice));
            ...
            Expression<Func<vm_ItemsPurchasePrice, bool>> predicate = Expression.Lambda<Func<vm_ItemsPurchasePrice, bool>>(expr, parameter);
