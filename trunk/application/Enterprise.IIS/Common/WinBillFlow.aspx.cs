...
{
    public partial class WinBillFlow : PageBase
    {
        ...
        protected BillFlowServie BillFlowServie
        {
            get
            {
                return _billFlowServie ?? //
                    (_billFlowServie = new BillFlowServie());
            }
        ...
        protected void btnExport_Click(object sender, EventArgs e)
        {
            ...
            Response.AddHeader("content-disposition", string.Format(@"attachment; filename=审批过程详情{0}.xls", SequenceGuid.GetGuidReplace()));
        ...
        /// <returns></returns>
        private Expression<Func<LHBillFlow, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            // 查询条件表达式
            Expression expr = Expression.Constant(true);

            ParameterExpression parameter = Expression.Parameter(typeof(LHBillFlow));
            ...
            expr = Expression.And(expr,
                ...
                // ReSharper disable once PossiblyMistakenUseOfParamsMethod
                    Expression.Constant(KeyId)));

            Expression<Func<LHBillFlow, bool>> predicate = Expression.Lambda<Func<LHBillFlow, bool>>(expr, parameter);
