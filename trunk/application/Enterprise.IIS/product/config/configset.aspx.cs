...
namespace Enterprise.IIS.product.config
{
    public partial class configset : PageBase
    {
        /// <summary>
        ///     网站信息
        /// </summary>
        ...
        protected void FileUploader1_FileReceived(object sender, FileReceivedEventArgs e)
        {
            ...
            // var s=  e.File.FileName.Insert(e.File.FileName.LastIndexOf('.'), DateTime.Now.ToString("yyyyMMddHHmmss"));
