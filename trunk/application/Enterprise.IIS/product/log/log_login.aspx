<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="log_login.aspx.cs" Inherits="Enterprise.IIS.product.log.log_login" %>
...
<body>
    ...
    <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
        <Regions>
            <f:Region ID="Region1" ShowBorder="false" ShowHeader="False" Title="登录管理" Position="Center"
                                        ...
                                        <Rows>
                                            <f:FormRow ID="FormRow1">
                                                <Items>
                                                    ...
                                                    <f:DatePicker ID="dpBeginDate" runat="server" Required="false" Label="开始日期" EmptyText="请选择开始日期"
                                                        ShowRedStar="false">
                                                    </f:DatePicker>
                                                    <f:DatePicker ID="dpEndDate" runat="server" Required="false" Label="结束日期" EmptyText="请选择结束日期"
                                                        ShowRedStar="false">
                                                    </f:DatePicker>
                            ...
                            <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                ...
                                <Items>
                                    <f:Grid ID="Grid1" Title="登录管理" PageSize="20" ShowBorder="False" ShowHeader="False"
                                        ...
                                        <Columns>
                                            <f:BoundField Width="300px" DataField="account_name" HeaderText="登录账号" SortField="account_name" />
                                            <f:BoundField Width="200px" DataField="account_address" HeaderText="登录地址" SortField="account_address" />
                                            <f:BoundField Width="300px" DataField="action_desc" HeaderText="登录状态" SortField="action_desc" />
