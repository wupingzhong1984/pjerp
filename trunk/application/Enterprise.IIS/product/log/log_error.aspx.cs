...
// ReSharper disable once InconsistentNaming
    public partial class log_error : PageBase
    {
        ...
        {
            get { return _errorsService ?? (_errorsService = new ErrorsService()); }
            set { _errorsService = value; }
        }
        ...
        private void BindDataGrid()
        {
            ...
            Expression<Func<t_errors, bool>> predicate = BuildPredicate(out orderingSelector);
            //取数据源
            IQueryable<t_errors> list = ErrorsService.Where(predicate, Grid1.PageSize, Grid1.PageIndex + 1,
        ...
        /// <returns></returns>
        private Expression<Func<t_errors, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            // 查询条件表达式
            Expression expr = Expression.Constant(true);

            ParameterExpression parameter = Expression.Parameter(typeof(t_errors));
...
// ReSharper disable once PossiblyMistakenUseOfParamsMethod
            ...
            Expression<Func<t_errors, bool>> predicate = Expression.Lambda<Func<t_errors, bool>>(expr, parameter);
