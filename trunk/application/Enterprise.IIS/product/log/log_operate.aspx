<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="log_operate.aspx.cs" Inherits="Enterprise.IIS.product.log.log_operate" %>
...
<body>
    ...
    <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
        <Regions>
            <f:Region ID="Region1" ShowBorder="false" ShowHeader="False" Title="操作日志" Position="Center" Layout="Fit"
                    ...
                    <f:RegionPanel ID="RegionPanel2" ShowBorder="false" runat="server">
                        <Regions>
                            ...
                            <f:Region ID="Region4" ShowBorder="False" ShowHeader="false" Position="Center"
                                ...
                                <Items>
                                    <f:Grid ID="Grid1" Title="操作日志" PageSize="20" ShowBorder="False" ShowHeader="False"
                                        ...
                                        <Columns>
                                            ...
                                            <f:BoundField Width="100px" DataField="account_id" HeaderText="登录账号" SortField="account_id" />--%>
                                            <f:BoundField Width="100px" DataField="account_name" HeaderText="登录账号" SortField="account_name" />
                                            <f:BoundField Width="380px" DataField="action_desc" HeaderText="描述" SortField="action_desc" />
                                            <f:BoundField Width="200px" DataField="account_ip" HeaderText="IP" SortField="account_ip" />
                                            <f:BoundField Width="200px" DataField="action_on" HeaderText="操作时间" SortField="action_on" />
                                        </Columns>
                                        <PageItems>
