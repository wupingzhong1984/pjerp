...
// ReSharper disable once InconsistentNaming
    public partial class log_login : PageBase
    {
        ...
        private LoginSevice _loginSevice;


        protected LoginSevice LoginSevice
        {
            get { return _loginSevice ?? (_loginSevice = new LoginSevice()); }
            set { _loginSevice = value; }
        }
        ...
        private void BindDataGrid()
        {
            ...
            Expression<Func<t_logins, bool>> predicate = BuildPredicate(out orderingSelector);
            //取数据源
            IQueryable<t_logins> list = LoginSevice.Where(predicate, Grid1.PageSize, Grid1.PageIndex + 1,
        ...
        /// <returns></returns>
        private Expression<Func<t_logins, bool>> BuildPredicate(out dynamic orderingSelector)
        {
            // 查询条件表达式
            Expression expr = Expression.Constant(true);

            ParameterExpression parameter = Expression.Parameter(typeof(t_logins));
...
// ReSharper disable once PossiblyMistakenUseOfParamsMethod
            ...
            Expression<Func<t_logins, bool>> predicate = Expression.Lambda<Func<t_logins, bool>>(expr, parameter);
