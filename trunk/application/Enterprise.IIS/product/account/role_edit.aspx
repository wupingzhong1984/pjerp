<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="role_edit.aspx.cs" Inherits="Enterprise.IIS.product.account.role_edit" %>
...
<body>
    ...
    <f:RegionPanel ID="RegionPanel1" ShowBorder="false" runat="server">
        <Regions>
            <f:Region ID="Region1" Title="授权配置" ShowBorder="false" ShowHeader="False" Position="Center"
                ...
                <Toolbars>
                    <f:Toolbar ID="Toolbar1" runat="server"  Position="Top" ToolbarAlign="Left">
                        <Items>
                            <f:Button ID="btnSelAll" IconUrl="~/icon/comments_add.png" OnClientClick="checkSelAll();"
                                Text="全选" runat="server" Size="Medium"/>
                            <f:Button ID="btnQxAll" IconUrl="~/icon/comments_delete.png" OnClientClick="checkQxAll();"
                                Text="取消全选" runat="server" Size="Medium"/>
                            <f:Button ID="btnSubmit" IconUrl="~/icon/database_add.png" OnClick="btnSava_Click"
                                Text="提交表单" runat="server" Size="Medium">
                            </f:Button>
                            <f:Button ID="btnBackup" runat="server" Text="返回" IconUrl="~/icon/arrow_redo.png"
                                OnClick="btnReturn_Click" Size="Medium"/>
                        </Items>
                    </f:Toolbar>
                </Toolbars>
                <Items>
                        ...
                        <Items>
                            <f:GroupPanel runat="server" Title="基本信息" ID="GPanelRoleInfo" EnableCollapse="True">
                                <Items>
                                    ...
                                    <f:TextBox ID="txtrole_desc" runat="server" Label="角色描述" EmptyText="角色描述"  LabelAlign="Right">
                                    </f:TextBox>
                                </Items>
                            </f:GroupPanel>
    ...
    <script type="text/javascript">
        Ext.onReady(function () {
            var actionList = X('<%= cboxListActions.ClientID %>').items;
